...
var ParseRules = {
  Document: [p$1("{"), list$1("Variable", opt(p$1(","))), p$1("}")],
  Variable: [namedKey("variable"), p$1(":"), "Value"],
  Value(token) {
    switch (token.kind) {
      case "Number":
        return "NumberValue";
  ...
  ListValue: [p$1("["), list$1("Value", opt(p$1(","))), p$1("]")],
  ObjectValue: [p$1("{"), list$1("ObjectField", opt(p$1(","))), p$1("}")],
  ObjectField: [namedKey("attribute"), p$1(":"), "Value"]
};
...
//# sourceMappingURL=mode.es3-73XTMRPK.js.map
