...
var setInRecursor = function setInRecursor2(current, index, path, value, destroyArrays) {
  ...
  if (isNaN(key)) {
    ...
    if (current === void 0 || current === null) {
      var _ref;
      var _result2 = setInRecursor2(void 0, index + 1, path, value, destroyArrays);
      return _result2 === void 0 ? void 0 : (_ref = {}, _ref[key] = _result2, _ref);
    }
    if (Array.isArray(current)) {
      throw new Error("Cannot set a non-numeric property on an array");
    }
    var _result = setInRecursor2(current[key], index + 1, path, value, destroyArrays);
    if (_result === void 0) {
...
//# sourceMappingURL=chunk-GM674NJC.js.map
