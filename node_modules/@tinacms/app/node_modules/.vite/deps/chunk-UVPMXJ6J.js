...
(function(module, exports) {
  (function(global, factory) {
    ...
    var rmClass = __name(function(node, cls) {
    ...
    if (document.createRange) {
      range = __name(function(node, start, end, endNode) {
      ...
      range = __name(function(node, start, end) {
    ...
    var selectInput = __name(function(node) {
      node.select();
    }, "selectInput");
    if (ios) {
      selectInput = __name(function(node) {
    ...
    var noHandlers = [];
    var on = __name(function(emitter, type, f) {
    ...
    var StringStream = __name(function(string, tabSize, lineOracle) {
    ...
    var SavedContext = __name(function(state, lookAhead) {
      this.state = state;
      this.lookAhead = lookAhead;
    }, "SavedContext");
    var Context = __name(function(doc, state, line, lookAhead) {
      this.state = state;
      this.doc = doc;
      this.line = line;
    ...
    var Token = __name(function(stream, type, state) {
    ...
    var Line = __name(function(text, markedSpans, estimateHeight2) {
      this.text = text;
    ...
    var NativeScrollbars = __name(function(place, scroll, cm) {
      this.cm = cm;
    ...
    var NullScrollbars = __name(function() {
    }, "NullScrollbars");
    ...
    var DisplayUpdate = __name(function(cm, viewport, force) {
      var display = cm.display;
    ...
    var Selection = __name(function(ranges, primIndex) {
      this.ranges = ranges;
    ...
    var Range = __name(function(anchor, head) {
      this.anchor = anchor;
      this.head = head;
    }, "Range");
    ...
    var LineWidget = __name(function(doc, node, options) {
      if (options) {
    ...
    var nextMarkerId = 0;
    var TextMarker = __name(function(doc, type) {
      this.lines = [];
      this.type = type;
      this.doc = doc;
    ...
    var SharedTextMarker = __name(function(markers, primary) {
    ...
    var nextDocId = 0;
    var Doc = __name(function(text, mode, firstLine, lineSep, direction) {
    ...
    function onDrop(e) {
      ...
      if (files && files.length && window.FileReader && window.File) {
        ...
        var markAsReadAndPasteIfAllFilesAreRead = __name(function() {
          if (++read == n) {
        ...
        var readTextFromFile = __name(function(file, i3) {
    ...
    function moveVisually(cm, line, start, dir) {
      ...
      var mv = __name(function(pos, dir2) {
        return moveCharLogically(line, pos instanceof Pos ? pos.ch : pos, dir2);
      }, "mv");
      var prep;
      var getWrappedLineExtent = __name(function(ch2) {
        if (!cm.options.lineWrapping) {
      ...
      var searchInVisualLine = __name(function(partPos2, dir2, wrappedLineExtent3) {
        var getRes = __name(function(ch3, moveInStorageOrder3) {
    ...
    var PastClick = __name(function(time, pos, button) {
      this.time = time;
      this.pos = pos;
      this.button = button;
    }, "PastClick");
    ...
    function leftButtonStartDrag(cm, event, pos, behavior) {
      ...
      var mouseMove = __name(function(e2) {
        moved = moved || Math.abs(event.clientX - e2.clientX) + Math.abs(event.clientY - e2.clientY) >= 10;
      }, "mouseMove");
      var dragStart = __name(function() {
        return moved = true;
      }, "dragStart");
      if (webkit) {
    ...
    function addEditorMethods(CodeMirror3) {
      ...
      CodeMirror3.prototype = {
        ...
        setSize: methodOp(function(width, height) {
          var this$1$1 = this;
          var interpret = __name(function(val) {
    ...
    var ContentEditableInput = __name(function(cm) {
      this.cm = cm;
    ...
    var TextareaInput = __name(function(cm) {
      this.cm = cm;
      this.prevInput = "";
...
//# sourceMappingURL=chunk-UVPMXJ6J.js.map
