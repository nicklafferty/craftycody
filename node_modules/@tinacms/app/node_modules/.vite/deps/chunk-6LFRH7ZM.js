...
function onMouseOver(cm, e) {
  ...
  const onMouseMove = __name(function() {
    clearTimeout(state.hoverTimeout);
    state.hoverTimeout = setTimeout(onHover, hoverTime);
  }, "onMouseMove");
  const onMouseOut = __name(function() {
    CodeMirror.off(document, "mousemove", onMouseMove);
    CodeMirror.off(cm.getWrapperElement(), "mouseout", onMouseOut);
    clearTimeout(state.hoverTimeout);
    state.hoverTimeout = void 0;
  }, "onMouseOut");
  const onHover = __name(function() {
    CodeMirror.off(document, "mousemove", onMouseMove);
    CodeMirror.off(cm.getWrapperElement(), "mouseout", onMouseOut);
    state.hoverTimeout = void 0;
    onMouseHover(cm, box);
...
function showPopup(cm, box, info) {
  ...
  let popupTimeout;
  const onMouseOverPopup = __name(function() {
  ...
  const hidePopup = __name(function() {
...
//# sourceMappingURL=chunk-6LFRH7ZM.js.map
