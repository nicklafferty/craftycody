...
var __name$G = __name((target2, value3) => __defProp$G(target2, "name", { value: value3, configurable: true }), "__name$G");
...
function createContextHook(context) {
  function useGivenContext(options) {
    var _a;
    const value3 = (0, import_react.useContext)(context);
...
var n$2 = Object.prototype.hasOwnProperty;
var p$2 = { key: true, ref: true, __self: true, __source: true };
...
var Fragment2 = jsxRuntime.exports.Fragment;
var __defProp$F = Object.defineProperty;
var __name$F = __name((target2, value3) => __defProp$F(target2, "name", { value: value3, configurable: true }), "__name$F");
...
function StorageContextProvider(props2) {
  ...
  const [storage, setStorage] = (0, import_react.useState)(new StorageAPI(props2.storage));
  ...
  return jsx(StorageContext.Provider, {
    value: storage,
...
(function(DirectiveLocation22) {
  DirectiveLocation22["QUERY"] = "QUERY";
  DirectiveLocation22["MUTATION"] = "MUTATION";
  DirectiveLocation22["SUBSCRIPTION"] = "SUBSCRIPTION";
  DirectiveLocation22["FIELD"] = "FIELD";
  DirectiveLocation22["FRAGMENT_DEFINITION"] = "FRAGMENT_DEFINITION";
  DirectiveLocation22["FRAGMENT_SPREAD"] = "FRAGMENT_SPREAD";
  DirectiveLocation22["INLINE_FRAGMENT"] = "INLINE_FRAGMENT";
  DirectiveLocation22["VARIABLE_DEFINITION"] = "VARIABLE_DEFINITION";
  DirectiveLocation22["SCHEMA"] = "SCHEMA";
  DirectiveLocation22["SCALAR"] = "SCALAR";
  DirectiveLocation22["OBJECT"] = "OBJECT";
  DirectiveLocation22["FIELD_DEFINITION"] = "FIELD_DEFINITION";
  DirectiveLocation22["ARGUMENT_DEFINITION"] = "ARGUMENT_DEFINITION";
  DirectiveLocation22["INTERFACE"] = "INTERFACE";
  DirectiveLocation22["UNION"] = "UNION";
  DirectiveLocation22["ENUM"] = "ENUM";
  DirectiveLocation22["ENUM_VALUE"] = "ENUM_VALUE";
  DirectiveLocation22["INPUT_OBJECT"] = "INPUT_OBJECT";
  DirectiveLocation22["INPUT_FIELD_DEFINITION"] = "INPUT_FIELD_DEFINITION";
...
function visit2(root2, visitor, visitorKeys = QueryDocumentKeys) {
...
function print2(ast2) {
  return visit2(ast2, printDocASTReducer);
}
__name(print2, "print");
...
var instanceOf = __name(function instanceOf2(value3, constructor) {
...
__name(isAbstractType2, "isAbstractType");
var GraphQLList2 = class {
  constructor(ofType) {
    isType2(ofType) || devAssert(false, `Expected ${inspect(ofType)} to be a GraphQL type.`);
    this.ofType = ofType;
  }
  get [Symbol.toStringTag]() {
    return "GraphQLList";
...
__name(GraphQLList2, "GraphQLList");
...
var GraphQLInt = new GraphQLScalarType({
  ...
  parseLiteral(valueNode) {
    if (valueNode.kind !== Kind2.INT) {
      throw new GraphQLError(`Int cannot represent non-integer value: ${print2(valueNode)}`, {
        nodes: valueNode
      });
    }
...
var GraphQLFloat2 = new GraphQLScalarType({
  name: "Float",
  ...
  parseLiteral(valueNode) {
    if (valueNode.kind !== Kind2.FLOAT && valueNode.kind !== Kind2.INT) {
      throw new GraphQLError(`Float cannot represent non numeric value: ${print2(valueNode)}`, valueNode);
    }
    return parseFloat(valueNode.value);
  }
});
var GraphQLString = new GraphQLScalarType({
  ...
  parseLiteral(valueNode) {
    if (valueNode.kind !== Kind2.STRING) {
      throw new GraphQLError(`String cannot represent a non string value: ${print2(valueNode)}`, {
        nodes: valueNode
      });
    }
    return valueNode.value;
...
var GraphQLBoolean2 = new GraphQLScalarType({
  name: "Boolean",
  ...
  parseLiteral(valueNode) {
    if (valueNode.kind !== Kind2.BOOLEAN) {
      throw new GraphQLError(`Boolean cannot represent a non boolean value: ${print2(valueNode)}`, {
        nodes: valueNode
      });
    }
    return valueNode.value;
...
var GraphQLID = new GraphQLScalarType({
  ...
  parseLiteral(valueNode) {
    if (valueNode.kind !== Kind2.STRING && valueNode.kind !== Kind2.INT) {
      throw new GraphQLError("ID cannot represent a non-string and non-integer value: " + print2(valueNode), {
        nodes: valueNode
      });
    }
    return valueNode.value;
...
function astFromValue2(value3, type2) {
  if (isNonNullType2(type2)) {
    const astValue = astFromValue2(value3, type2.ofType);
    if ((astValue === null || astValue === void 0 ? void 0 : astValue.kind) === Kind2.NULL) {
      return null;
    }
    return astValue;
  }
  ...
  if (isListType2(type2)) {
    ...
    return astFromValue2(value3, itemType);
  }
  if (isInputObjectType2(type2)) {
    ...
    for (const field of Object.values(type2.getFields())) {
      const fieldValue = astFromValue2(value3[field.name], field.type);
      if (fieldValue) {
        fieldNodes.push({
...
var __Schema = new GraphQLObjectType2({
  name: "__Schema",
  ...
  fields: () => ({
    ...
    types: {
      ...
      type: new GraphQLNonNull(new GraphQLList2(new GraphQLNonNull(__Type))),
      resolve(schema) {
    ...
    directives: {
      ...
      type: new GraphQLNonNull(new GraphQLList2(new GraphQLNonNull(__Directive))),
      resolve: (schema) => schema.getDirectives()
    }
  })
});
var __Directive = new GraphQLObjectType2({
  name: "__Directive",
  ...
  fields: () => ({
    ...
    isRepeatable: {
      type: new GraphQLNonNull(GraphQLBoolean2),
      resolve: (directive2) => directive2.isRepeatable
    },
    locations: {
      type: new GraphQLNonNull(new GraphQLList2(new GraphQLNonNull(__DirectiveLocation))),
      resolve: (directive2) => directive2.locations
    },
    args: {
      type: new GraphQLNonNull(new GraphQLList2(new GraphQLNonNull(__InputValue))),
      args: {
        includeDeprecated: {
          type: GraphQLBoolean2,
          defaultValue: false
        }
      },
...
var __DirectiveLocation = new GraphQLEnumType2({
  name: "__DirectiveLocation",
  description: "A Directive can be adjacent to many parts of the GraphQL language, a __DirectiveLocation describes one such possible adjacencies.",
  values: {
    QUERY: {
      value: DirectiveLocation2.QUERY,
      description: "Location adjacent to a query operation."
    },
    MUTATION: {
      value: DirectiveLocation2.MUTATION,
      description: "Location adjacent to a mutation operation."
    },
    SUBSCRIPTION: {
      value: DirectiveLocation2.SUBSCRIPTION,
      description: "Location adjacent to a subscription operation."
    },
    FIELD: {
      value: DirectiveLocation2.FIELD,
      description: "Location adjacent to a field."
    },
    FRAGMENT_DEFINITION: {
      value: DirectiveLocation2.FRAGMENT_DEFINITION,
      description: "Location adjacent to a fragment definition."
    },
    FRAGMENT_SPREAD: {
      value: DirectiveLocation2.FRAGMENT_SPREAD,
      description: "Location adjacent to a fragment spread."
    },
    INLINE_FRAGMENT: {
      value: DirectiveLocation2.INLINE_FRAGMENT,
      description: "Location adjacent to an inline fragment."
    },
    VARIABLE_DEFINITION: {
      value: DirectiveLocation2.VARIABLE_DEFINITION,
      description: "Location adjacent to a variable definition."
    },
    SCHEMA: {
      value: DirectiveLocation2.SCHEMA,
      description: "Location adjacent to a schema definition."
    },
    SCALAR: {
      value: DirectiveLocation2.SCALAR,
      description: "Location adjacent to a scalar definition."
    },
    OBJECT: {
      value: DirectiveLocation2.OBJECT,
      description: "Location adjacent to an object type definition."
    },
    FIELD_DEFINITION: {
      value: DirectiveLocation2.FIELD_DEFINITION,
      description: "Location adjacent to a field definition."
    },
    ARGUMENT_DEFINITION: {
      value: DirectiveLocation2.ARGUMENT_DEFINITION,
      description: "Location adjacent to an argument definition."
    },
    INTERFACE: {
      value: DirectiveLocation2.INTERFACE,
      description: "Location adjacent to an interface definition."
    },
    UNION: {
      value: DirectiveLocation2.UNION,
      description: "Location adjacent to a union definition."
    },
    ENUM: {
      value: DirectiveLocation2.ENUM,
      description: "Location adjacent to an enum definition."
    },
    ENUM_VALUE: {
      value: DirectiveLocation2.ENUM_VALUE,
      description: "Location adjacent to an enum value definition."
    },
    INPUT_OBJECT: {
      value: DirectiveLocation2.INPUT_OBJECT,
      description: "Location adjacent to an input object type definition."
    },
    INPUT_FIELD_DEFINITION: {
      value: DirectiveLocation2.INPUT_FIELD_DEFINITION,
      description: "Location adjacent to an input object field definition."
    }
  }
});
var __Type = new GraphQLObjectType2({
  name: "__Type",
  ...
  fields: () => ({
    ...
    fields: {
      type: new GraphQLList2(new GraphQLNonNull(__Field)),
      args: {
        includeDeprecated: {
          type: GraphQLBoolean2,
          defaultValue: false
      ...
      resolve(type2, { includeDeprecated }) {
        if (isObjectType2(type2) || isInterfaceType2(type2)) {
    ...
    interfaces: {
      type: new GraphQLList2(new GraphQLNonNull(__Type)),
      resolve(type2) {
        if (isObjectType2(type2) || isInterfaceType2(type2)) {
    ...
    enumValues: {
      type: new GraphQLList2(new GraphQLNonNull(__EnumValue)),
      args: {
        includeDeprecated: {
          type: GraphQLBoolean2,
          defaultValue: false
    ...
    inputFields: {
      type: new GraphQLList2(new GraphQLNonNull(__InputValue)),
      args: {
        includeDeprecated: {
          type: GraphQLBoolean2,
          defaultValue: false
...
var __Field = new GraphQLObjectType2({
  name: "__Field",
...
var __InputValue = new GraphQLObjectType2({
  name: "__InputValue",
  ...
  fields: () => ({
    ...
    defaultValue: {
      ...
      resolve(inputValue) {
        ...
        const valueAST = astFromValue2(defaultValue2, type2);
...
var __EnumValue = new GraphQLObjectType2({
  name: "__EnumValue",
...
var __TypeKind = new GraphQLEnumType2({
  name: "__TypeKind",
...
function getFieldDef(schema, type2, fieldName) {
  if (fieldName === SchemaMetaFieldDef2.name && schema.getQueryType() === type2) {
    return SchemaMetaFieldDef2;
  }
  if (fieldName === TypeMetaFieldDef2.name && schema.getQueryType() === type2) {
    return TypeMetaFieldDef2;
  }
  if (fieldName === TypeNameMetaFieldDef2.name && isCompositeType(type2)) {
    return TypeNameMetaFieldDef2;
  }
  if ("getFields" in type2) {
...
__name(p$1, "p$1");
var isIgnored = __name((ch) => ch === " " || ch === "	" || ch === "," || ch === "\n" || ch === "\r" || ch === "\uFEFF" || ch === " ", "isIgnored");
var LexRules = {
...
function onlineParser(options = {
  ...
  return {
    startState() {
      ...
      pushRule(options.parseRules, initialState2, Kind.DOCUMENT);
...
var collectFragmentDefs = __name((op) => {
...
var hasTypeSystemDefinitions = __name((sdl) => {
...
function getAutocompleteSuggestions(schema, queryText, cursor, contextToken, fragmentDefs, options) {
  ...
  if ((prevState === null || prevState === void 0 ? void 0 : prevState.kind) === Kind.SCALAR_TYPE_EXTENSION) {
    return hintList(token2, Object.values(schema.getTypeMap()).filter(isScalarType).map((type2) => ({
      label: type2.name,
      kind: CompletionItemKind.Function
    })));
  }
  if ((prevState === null || prevState === void 0 ? void 0 : prevState.kind) === Kind.OBJECT_TYPE_EXTENSION) {
    return hintList(token2, Object.values(schema.getTypeMap()).filter((type2) => isObjectType(type2) && !type2.name.startsWith("__")).map((type2) => ({
      label: type2.name,
      kind: CompletionItemKind.Function
    })));
  }
  if ((prevState === null || prevState === void 0 ? void 0 : prevState.kind) === Kind.INTERFACE_TYPE_EXTENSION) {
    return hintList(token2, Object.values(schema.getTypeMap()).filter(isInterfaceType).map((type2) => ({
      label: type2.name,
      kind: CompletionItemKind.Function
    })));
  }
  if ((prevState === null || prevState === void 0 ? void 0 : prevState.kind) === Kind.UNION_TYPE_EXTENSION) {
    return hintList(token2, Object.values(schema.getTypeMap()).filter(isUnionType).map((type2) => ({
      label: type2.name,
      kind: CompletionItemKind.Function
    })));
  }
  if ((prevState === null || prevState === void 0 ? void 0 : prevState.kind) === Kind.ENUM_TYPE_EXTENSION) {
    return hintList(token2, Object.values(schema.getTypeMap()).filter((type2) => isEnumType(type2) && !type2.name.startsWith("__")).map((type2) => ({
      label: type2.name,
      kind: CompletionItemKind.Function
    })));
  }
  if ((prevState === null || prevState === void 0 ? void 0 : prevState.kind) === Kind.INPUT_OBJECT_TYPE_EXTENSION) {
    return hintList(token2, Object.values(schema.getTypeMap()).filter(isInputObjectType).map((type2) => ({
      label: type2.name,
      kind: CompletionItemKind.Function
    })));
  }
...
var getInsertText = __name((field) => {
      ...
      if (state2.kind === RuleKinds.NAMED_TYPE && ((_a = state2.prevState) === null || _a === void 0 ? void 0 : _a.kind) === RuleKinds.IMPLEMENTS) {
        if (typeInfo.interfaceDef) {
          ...
          typeInfo.interfaceDef = new GraphQLInterfaceType(Object.assign(Object.assign({}, interfaceConfig), { interfaces: [
            ...
            type2 || new GraphQLInterfaceType({ name: state2.name, fields: {} })
          ] }));
...
var getParentDefinition = __name((state2, kind) => {
  ...
  forEachState(tokenState, (state2) => {
    ...
    switch (state2.kind) {
      ...
      case RuleKinds.ENUM_VALUE:
        ...
        enumValue = enumType instanceof GraphQLEnumType ? enumType.getValues().find((val) => val.value === state2.name) : null;
        break;
...
var nullthrows$1 = getDefaultExportFromCjs(nullthrows$2.exports);
var getFragmentDependenciesForAST = __name((parsedOperation, fragmentDefinitions) => {
...
var isPrimitive$1 = __name(function isPrimitive(val) {
  if (typeof val === "object") {
    return val === null;
  }
  return typeof val !== "function";
}, "isPrimitive");
var isobject = __name(function isObject(val) {
...
var isPlainObject$1 = __name(function isPlainObject(o2) {
  var ctor, prot;
...
var isObject$1 = __name((value3) => {
  return typeof value3 === "object" && value3 !== null || typeof value3 === "function";
}, "isObject$1");
var isUnsafeKey = __name((key) => {
  return key === "__proto__" || key === "constructor" || key === "prototype";
}, "isUnsafeKey");
var validateKey = __name((key) => {
  if (!isPrimitive2(key)) {
...
var toStringKey = __name((input) => {
  return Array.isArray(input) ? input.flat().map(String).join(",") : input;
}, "toStringKey");
var createMemoKey = __name((input, options) => {
...
var memoize = __name((input, options, fn) => {
...
var splitString = __name((input, options = {}) => {
...
var split = __name((input, options) => {
...
var assignProp = __name((obj, prop2, value3, options) => {
  validateKey(prop2);
  if (value3 === void 0) {
...
var setValue = __name((target2, path, value3, options) => {
...
function SvgArgument(_a) {
  ...
  }, props2), title ? React.createElement("title", {
    id: titleId
...
function SvgDeprecatedField(_q) {
  ...
  return React.createElement("svg", Object.assign({
    ...
    id: titleId
  }, title) : null, React.createElement("rect", {
    x: 0.6,
    y: 0.6,
    width: 10.8,
    height: 10.8,
...
var __name$E = __name((target2, value3) => __defProp$E(target2, "name", { value: value3, configurable: true }), "__name$E");
...
function generateIcon(RawComponent, title) {
  const WithTitle = __name$E(__name(function IconComponent(props2) {
    return jsx(RawComponent, __spreadProps(__spreadValues({}, props2), {
      title
    }));
...
function useForceUpdate() {
  var _useState = (0, import_react.useState)(/* @__PURE__ */ Object.create(null)), dispatch = _useState[1];
...
var PortalImpl = __name(function PortalImpl2(_ref2) {
  ...
  return portalNode.current ? (0, import_react_dom.createPortal)(children, portalNode.current) : (0, import_react.createElement)("span", {
    ref: mountNode
  });
}, "PortalImpl");
var Portal = __name(function Portal2(_ref2) {
  var unstable_skipInitialRender = _ref2.unstable_skipInitialRender, props2 = _objectWithoutPropertiesLoose$b(_ref2, _excluded$a);
  var _React$useState = (0, import_react.useState)(false), hydrated = _React$useState[0], setHydrated = _React$useState[1];
  ...
  return (0, import_react.createElement)(PortalImpl, props2);
}, "Portal");
...
function useComposedRefs() {
  ...
  return (0, import_react.useCallback)(function(node) {
...
var factoryWithThrowingShims$1 = __name(function() {
...
var __assign = __name(function() {
  __assign = Object.assign || __name(function __assign2(t2) {
...
var SideCar$1 = __name(function(_a) {
...
var emptyArray = [];
var FocusLock$1 = React.forwardRef(__name(function FocusLockUI(props2, parentRef) {
  var _extends2;
  ...
  return React.createElement(React.Fragment, null, hasLeadingGuards && [
    ...
    hasPositiveIndices ? React.createElement("div", {
      key: "guard-nearest",
      "data-focus-guard": true,
    ...
    returnFocus,
    focusOptions
  }), React.createElement(Container, _extends$a({
    ref: mergedRef
  }, lockProps, {
    className,
    onBlur: onBlur3,
...
function _setPrototypeOf(o2, p2) {
  _setPrototypeOf = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : __name(function _setPrototypeOf2(o3, p3) {
    o3.__proto__ = p3;
    return o3;
  }, "_setPrototypeOf");
...
function withSideEffect(reducePropsToState2, handleStateChangeOnClient2) {
  ...
  return __name(function wrap2(WrappedComponent) {
    ...
    var SideEffect = function(_PureComponent) {
      ...
      SideEffect2.peek = __name(function peek() {
        return state2;
      }, "peek");
      ...
      _proto.componentDidUpdate = __name(function componentDidUpdate() {
        emitChange();
      }, "componentDidUpdate");
      ...
      _proto.render = __name(function render() {
        return jsx(WrappedComponent, __spreadValues({}, this.props));
      }, "render");
      return SideEffect2;
...
var toArray = __name(function(a2) {
...
var asArray = __name(function(a2) {
  return Array.isArray(a2) ? a2 : [a2];
}, "asArray");
var isElementHidden = __name(function(node) {
...
var getParentNode = __name(function(node) {
  return node.parentNode && node.parentNode.nodeType === Node.DOCUMENT_FRAGMENT_NODE ? node.parentNode.host : node.parentNode;
}, "getParentNode");
var isTopNode = __name(function(node) {
  return node === document || node && node.nodeType === Node.DOCUMENT_NODE;
}, "isTopNode");
var isVisibleUncached = __name(function(node, checkParent) {
  return !node || isTopNode(node) || !isElementHidden(node) && checkParent(getParentNode(node));
}, "isVisibleUncached");
var isVisibleCached = __name(function(visibilityCache, node) {
...
var isAutoFocusAllowedUncached = __name(function(node, checkParent) {
  return node && !isTopNode(node) ? isAutoFocusAllowed(node) ? checkParent(getParentNode(node)) : false : true;
}, "isAutoFocusAllowedUncached");
var isAutoFocusAllowedCached = __name(function(cache, node) {
...
var getDataset = __name(function(node) {
  return node.dataset;
}, "getDataset");
var isHTMLButtonElement = __name(function(node) {
  return node.tagName === "BUTTON";
}, "isHTMLButtonElement");
var isHTMLInputElement = __name(function(node) {
  return node.tagName === "INPUT";
}, "isHTMLInputElement");
var isRadioElement = __name(function(node) {
  return isHTMLInputElement(node) && node.type === "radio";
}, "isRadioElement");
var notHiddenInput = __name(function(node) {
  return !((isHTMLInputElement(node) || isHTMLButtonElement(node)) && (node.type === "hidden" || node.disabled));
}, "notHiddenInput");
var isAutoFocusAllowed = __name(function(node) {
  var attribute2 = node.getAttribute(FOCUS_NO_AUTOFOCUS);
  return ![true, "true", ""].includes(attribute2);
}, "isAutoFocusAllowed");
var isGuard = __name(function(node) {
  var _a;
  return Boolean(node && ((_a = getDataset(node)) === null || _a === void 0 ? void 0 : _a.focusGuard));
}, "isGuard");
var isNotAGuard = __name(function(node) {
  return !isGuard(node);
}, "isNotAGuard");
var isDefined = __name(function(x2) {
  return Boolean(x2);
}, "isDefined");
var tabSort = __name(function(a2, b2) {
...
var orderByTabIndex = __name(function(nodes, filterNegative, keepGuards) {
...
var getFocusablesWithShadowDom = __name(function(parent, withGuards) {
  var _a;
...
var getFocusables = __name(function(parents, withGuards) {
...
var getParentAutofocusables = __name(function(parent) {
...
var filterFocusable = __name(function(nodes, visibilityCache) {
...
var filterAutoFocusable = __name(function(nodes, cache) {
  if (cache === void 0) {
...
var getTabbableNodes = __name(function(topNodes, visibilityCache, withGuards) {
  return orderByTabIndex(filterFocusable(getFocusables(topNodes, withGuards), visibilityCache), true, withGuards);
}, "getTabbableNodes");
var getAllTabbableNodes = __name(function(topNodes, visibilityCache) {
  return orderByTabIndex(filterFocusable(getFocusables(topNodes), visibilityCache), false);
}, "getAllTabbableNodes");
var parentAutofocusables = __name(function(topNode, visibilityCache) {
  return filterFocusable(getParentAutofocusables(topNode), visibilityCache);
}, "parentAutofocusables");
var contains = __name(function(scope, element) {
...
var filterNested = __name(function(nodes) {
...
var getTopParent = __name(function(node) {
  return node.parentNode ? getTopParent(node.parentNode) : node;
}, "getTopParent");
var getAllAffectedNodes = __name(function(node) {
...
var getNestedShadowActiveElement = __name(function(shadowRoot) {
...
var getActiveElement = __name(function() {
...
var focusInFrame = __name(function(frame) {
  return frame === document.activeElement;
}, "focusInFrame");
var focusInsideIframe = __name(function(topNode) {
  return Boolean(toArray(topNode.querySelectorAll("iframe")).some(function(node) {
    return focusInFrame(node);
  }));
}, "focusInsideIframe");
var focusInside = __name(function(topNode) {
...
var focusIsHidden = __name(function() {
  var activeElement = document && getActiveElement();
  if (!activeElement) {
    return false;
  }
...
var findSelectedRadio = __name(function(node, nodes) {
...
var correctNode = __name(function(node, nodes) {
  if (isRadioElement(node) && node.name) {
    return findSelectedRadio(node, nodes);
  }
  return node;
}, "correctNode");
var correctNodes = __name(function(nodes) {
...
var pickFirstFocus = __name(function(nodes) {
  if (nodes[0] && nodes.length > 1) {
    return correctNode(nodes[0], nodes);
  }
  return nodes[0];
}, "pickFirstFocus");
var pickFocusable = __name(function(nodes, index) {
  if (nodes.length > 1) {
...
var newFocus = __name(function(innerNodes, outerNodes, activeElement, lastNode) {
...
var getParents = __name(function(node, parents) {
  if (parents === void 0) {
    parents = [];
  }
  parents.push(node);
...
var getCommonParent = __name(function(nodeA, nodeB) {
...
var getTopCommonParent = __name(function(baseActiveElement, leftEntry, rightEntries) {
...
var getFocusMerge = __name(function(topNode, lastNode) {
  var activeElement = document && getActiveElement();
...
var getFocusabledIn = __name(function(topNode) {
  var entries = getAllAffectedNodes(topNode).filter(isNotAGuard);
...
var focusOn = __name(function(target2, focusOptions) {
  if ("focus" in target2) {
...
var setFocus = __name(function(topNode, lastNode, options) {
  if (options === void 0) {
    options = {};
  }
...
var focusOnBody = __name(function focusOnBody2() {
  return document && document.activeElement === document.body;
}, "focusOnBody");
var isFreeFocus = __name(function isFreeFocus2() {
...
var defaultWhitelist = __name(function defaultWhitelist2() {
  return true;
}, "defaultWhitelist");
var focusWhitelisted = __name(function focusWhitelisted2(activeElement) {
  return (lastActiveTrap.whiteList || defaultWhitelist)(activeElement);
}, "focusWhitelisted");
var recordPortal = __name(function recordPortal2(observerNode, portaledElement) {
  lastPortaledElement = {
    observerNode,
    portaledElement
  };
}, "recordPortal");
var focusIsPortaledPair = __name(function focusIsPortaledPair2(element) {
...
var extractRef$1 = __name(function extractRef(ref) {
  return ref && "current" in ref ? ref.current : ref;
}, "extractRef");
var focusWasOutside = __name(function focusWasOutside2(crossFrameOption) {
  if (crossFrameOption) {
    return Boolean(focusWasOutsideWindow);
  }
  return focusWasOutsideWindow === "meanwhile";
}, "focusWasOutside");
var checkInHost = __name(function checkInHost2(check2, el2, boundary) {
...
var withinHost = __name(function withinHost2(activeElement, workingArea) {
  return workingArea.some(function(area) {
    return checkInHost(activeElement, area, area);
  });
}, "withinHost");
var activateTrap = __name(function activateTrap2() {
  var result = false;
  if (lastActiveTrap) {
...
var onTrap = __name(function onTrap2(event) {
  if (activateTrap() && event) {
    event.stopPropagation();
    event.preventDefault();
  }
}, "onTrap");
var onBlur = __name(function onBlur2() {
  return deferAction(activateTrap);
}, "onBlur");
var onFocus = __name(function onFocus2(event) {
...
var FocusWatcher = __name(function FocusWatcher2() {
  return null;
}, "FocusWatcher");
var onWindowBlur = __name(function onWindowBlur2() {
  focusWasOutsideWindow = "just";
  setTimeout(function() {
    focusWasOutsideWindow = "meanwhile";
  }, 0);
}, "onWindowBlur");
var attachHandler = __name(function attachHandler2() {
  document.addEventListener("focusin", onTrap);
  document.addEventListener("focusout", onBlur);
  window.addEventListener("blur", onWindowBlur);
}, "attachHandler");
var detachHandler = __name(function detachHandler2() {
...
var FocusLockCombination = React.forwardRef(__name(function FocusLockUICombination(props2, ref) {
  return React.createElement(FocusLockUI2, _extends$a({
    sideCar: FocusTrap,
    ref
  }, props2));
...
var parse$1 = __name(function(x2) {
...
var getStyles$2 = __name(function(_a, allowRelative, gapMode, important) {
...
var RemoveScrollBar = __name(function(props2) {
...
var extractRef2 = __name(function(ref) {
  return ref && "current" in ref ? ref.current : ref;
}, "extractRef");
var deltaCompare = __name(function(x2, y2) {
  return x2[0] === y2[0] && x2[1] === y2[1];
}, "deltaCompare");
var generateStyle = __name(function(id2) {
...
var factoryWithThrowingShims = __name(function() {
  function shim(props2, propName, componentName, location, propFullName, secret) {
...
var _excluded2$5 = ["allowPinchZoom", "as", "dangerouslyBypassFocusLock", "dangerouslyBypassScrollLock", "initialFocusRef", "onClick", "onDismiss", "onKeyDown", "onMouseDown", "unstable_lockFocusAcrossFrames"];
var _excluded3$5 = ["as", "onClick", "onKeyDown"];
var _excluded4$4 = ["allowPinchZoom", "initialFocusRef", "isOpen", "onDismiss"];
({
  allowPinchZoom: PropTypes.bool,
  dangerouslyBypassFocusLock: PropTypes.bool,
  dangerouslyBypassScrollLock: PropTypes.bool,
  initialFocusRef: __name(function initialFocusRef() {
    return null;
  }, "initialFocusRef"),
  onDismiss: PropTypes.func
});
var DialogOverlay = (0, import_react.forwardRef)(__name(function DialogOverlay2(_ref2, forwardedRef) {
  ...
  return isOpen ? (0, import_react.createElement)(Portal, {
    "data-reach-dialog-wrapper": ""
  }, (0, import_react.createElement)(DialogInner, _extends$9({
    ref: forwardedRef,
    as: Comp
  }, props2))) : null;
}, "DialogOverlay"));
var DialogInner = (0, import_react.forwardRef)(__name(function DialogInner2(_ref2, forwardedRef) {
  ...
  var overlayNode = (0, import_react.useRef)(null);
  var ref = useComposedRefs(overlayNode, forwardedRef);
  var activateFocusLock = (0, import_react.useCallback)(function() {
  ...
  return (0, import_react.createElement)(FocusLock, {
    autoFocus: true,
    returnFocus: true,
  ...
  }, (0, import_react.createElement)(RemoveScroll, {
    allowPinchZoom,
    enabled: !dangerouslyBypassScrollLock
  }, (0, import_react.createElement)(Comp, _extends$9({}, props2, {
    ref,
...
var DialogContent = (0, import_react.forwardRef)(__name(function DialogContent2(_ref3, forwardedRef) {
  ...
  return (0, import_react.createElement)(Comp, _extends$9({
    "aria-modal": "true",
    role: "dialog",
    tabIndex: -1
  }, props2, {
...
var Dialog$1 = (0, import_react.forwardRef)(__name(function Dialog(_ref4, forwardedRef) {
  ...
  return (0, import_react.createElement)(DialogOverlay, {
    allowPinchZoom,
    initialFocusRef: initialFocusRef2,
    isOpen,
    onDismiss
  }, (0, import_react.createElement)(DialogContent, _extends$9({
    ref: forwardedRef
  }, props2)));
}, "Dialog"));
...
var VisuallyHidden = (0, import_react.forwardRef)(__name(function VisuallyHidden2(_ref2, ref) {
  ...
  return (0, import_react.createElement)(Comp, _extends$8({
    ref,
    style: _extends$8({
      border: 0,
      clip: "rect(0 0 0 0)",
...
var __name$D = __name((target2, value3) => __defProp$D(target2, "name", { value: value3, configurable: true }), "__name$D");
var createComponentGroup = __name$D((root2, children) => Object.entries(children).reduce((r2, [key, value3]) => {
  r2[key] = value3;
  return r2;
}, root2), "createComponentGroup");
var dialog = (() => ":root{--reach-dialog: 1}[data-reach-dialog-overlay]{background:hsla(0,0%,0%,.33);position:fixed;top:0;right:0;bottom:0;left:0;overflow:auto}[data-reach-dialog-content]{width:50vw;margin:10vh auto;background:white;padding:2rem;outline:none}[data-reach-dialog-overlay]{align-items:center;background-color:hsla(var(--color-neutral),var(--alpha-background-heavy));display:flex;justify-content:center;z-index:10}[data-reach-dialog-content]{background-color:hsl(var(--color-base));border:var(--popover-border);border-radius:var(--border-radius-12);box-shadow:var(--popover-box-shadow);margin:0;max-height:80vh;max-width:80vw;overflow:auto;padding:0;width:unset}.graphiql-dialog-close>svg{color:hsla(var(--color-neutral),var(--alpha-secondary));display:block;height:var(--px-12);padding:var(--px-12);width:var(--px-12)}\n")();
var DialogRoot = (0, import_react.forwardRef)((props2, ref) => jsx(Dialog$1, __spreadProps(__spreadValues({}, props2), {
  ref
})));
DialogRoot.displayName = "Dialog";
var DialogClose = (0, import_react.forwardRef)((props2, ref) => jsxs(UnStyledButton, __spreadProps(__spreadValues({}, props2), {
  ref,
  type: "button",
...
function useId(providedId) {
  ...
  if (typeof import_react.useId === "function") {
    var _id = (0, import_react.useId)(providedId);
    return providedId != null ? providedId : _id;
  }
  var initialId = providedId != null ? providedId : serverHandoffComplete ? genId() : null;
  var _React$useState = (0, import_react.useState)(initialId), id2 = _React$useState[0], setId = _React$useState[1];
  useIsomorphicLayoutEffect(function() {
    if (id2 === null) {
      setId(genId());
    }
...
var rectChanged = __name(function rectChanged2(a2, b2) {
  if (a2 === void 0) {
    a2 = {};
  }
  if (b2 === void 0) {
...
function observeRect(node, cb) {
  return {
    observe: __name(function observe() {
    ...
    unobserve: __name(function unobserve() {
...
function useRect(nodeRef, observeOrOptions, deprecated_onChange) {
  ...
  var _React$useState = (0, import_react.useState)(nodeRef.current), element = _React$useState[0], setElement = _React$useState[1];
  var initialRectIsSet = (0, import_react.useRef)(false);
  var initialRefIsSet = (0, import_react.useRef)(false);
  var _React$useState2 = (0, import_react.useState)(null), rect2 = _React$useState2[0], setRect = _React$useState2[1];
...
var _excluded2$4 = ["as", "targetRef", "position", "unstable_observableRefs"];
var Popover = (0, import_react.forwardRef)(__name(function Popover2(_ref2, ref) {
  ...
  return (0, import_react.createElement)(Portal, {
    unstable_skipInitialRender: unstable_skipInitialPortalRender
  }, (0, import_react.createElement)(PopoverImpl, _extends$7({
    ref
  }, props2)));
}, "Popover"));
var PopoverImpl = (0, import_react.forwardRef)(__name(function PopoverImpl2(_ref2, forwardedRef) {
  ...
  return (0, import_react.createElement)(Comp, _extends$7({
    "data-reach-popover": "",
    ref
  }, props2, {
    style: _extends$7({
...
var positionDefault = __name(function positionDefault2(targetRect, popoverRect) {
...
var positionMatchWidth = __name(function positionMatchWidth2(targetRect, popoverRect) {
  if (!targetRect || !popoverRect) {
    return {};
  }
...
function createDescendantContext(name2, initialValue) {
  ...
  var descendants = [];
  var ctx = (0, import_react.createContext)(_extends$6({
    descendants,
...
function useDescendant(descendant, context, indexProp) {
  var forceUpdate = useForceUpdate();
  var _React$useContext = (0, import_react.useContext)(context), registerDescendant = _React$useContext.registerDescendant, unregisterDescendant = _React$useContext.unregisterDescendant, descendants = _React$useContext.descendants;
...
function DescendantProvider(_ref2) {
  ...
  var registerDescendant = (0, import_react.useCallback)(function(_ref22) {
  ...
  var unregisterDescendant = (0, import_react.useCallback)(function(element) {
    if (!element) {
      return;
    }
    set2(function(items2) {
  ...
  return (0, import_react.createElement)(Ctx.Provider, {
...
function useDescendantKeyDown(context, options) {
  var _React$useContext2 = (0, import_react.useContext)(context), descendants = _React$useContext2.descendants;
  ...
  return __name(function handleKeyDown(event) {
...
function useStableCallback(callback) {
  return createStableCallbackHook(import_react.useEffect, callback);
}
...
function createContext(rootName, defaultContext) {
  ...
  function useContext$1(childName) {
    var context = (0, import_react.useContext)(Ctx);
    if (context) {
      return context;
    }
    if (defaultContext) {
...
function useStatefulRefValue(ref, initialState2) {
  var _useState = (0, import_react.useState)(initialState2), state2 = _useState[0], setState = _useState[1];
  var callbackRef = (0, import_react.useCallback)(function(refValue) {
...
function c$1(t2, n2) {
  ...
  var r2 = { config: t2, _options: n2, initialState: { value: t2.initial, actions: e$1(t2.states[t2.initial].entry).map(function(t3) {
    ...
    if (y2.on) {
      var d2 = e$1(y2.on[g2.type]), x2 = __name(function(n4) {
        if (n4 === void 0)
...
var getServiceState = __name(function getServiceState2(service) {
  var currentValue;
...
function useMachine(initialMachine, refs, DEBUG2) {
  var machineRef = (0, import_react.useRef)(initialMachine);
  var service = useConstant(function() {
    return f$1(machineRef.current).start();
  });
  var lastEventType = (0, import_react.useRef)(null);
  ...
  var send2 = (0, import_react.useCallback)(function(rawEvent) {
  ...
  (0, import_react.useEffect)(function() {
    service.subscribe(__name(function setStateIfChanged(newState) {
      if (newState.changed) {
        setState(newState);
      }
    }, "setStateIfChanged"));
  ...
  var memoizedState = (0, import_react.useMemo)(function() {
    return _extends$5({}, state2, {
      matches: __name(function matches2(value3) {
...
var clearNavigationValue = r$1({
  navigationValue: null
});
var clearTypeahead = r$1({
  typeaheadQuery: null
});
var assignValue = r$1({
  value: __name(function value(_, event) {
    return event.value;
  }, "value")
});
var navigate = r$1({
  navigationValue: __name(function navigationValue(data, event) {
    return event.value;
  }, "navigationValue")
});
var navigateFromCurrentValue = r$1({
  navigationValue: __name(function navigationValue2(data) {
...
var setTypeahead = r$1({
  typeaheadQuery: __name(function typeaheadQuery(data, event) {
    return (data.typeaheadQuery || "") + event.query;
  }, "typeaheadQuery")
});
var setValueFromTypeahead = r$1({
  value: __name(function value2(data, event) {
...
var setNavSelectionFromTypeahead = r$1({
  navigationValue: __name(function navigationValue3(data, event) {
    if (event.type === ListboxEvents.UpdateAfterTypeahead && event.query) {
      var match2 = findOptionFromTypeahead(data.options, event.query);
      if (match2 && !match2.disabled) {
        return match2.value;
...
var commonEvents = (_commonEvents = {}, _commonEvents[ListboxEvents.GetDerivedData] = {
  actions: r$1(function(ctx, event) {
    return _extends$4({}, ctx, event.data);
  })
}, _commonEvents[ListboxEvents.ValueChange] = {
  actions: [assignValue, selectOption]
}, _commonEvents);
var createMachineDefinition = __name(function createMachineDefinition2(_ref2) {
...
var _excluded2$3 = ["arrow", "button", "children", "portal"];
var _excluded3$4 = ["aria-label", "arrow", "as", "children", "onKeyDown", "onMouseDown", "onMouseUp"];
var _excluded4$3 = ["as", "children"];
var _excluded5$3 = ["as", "position", "onBlur", "onKeyDown", "onMouseUp", "portal", "unstable_observableRefs"];
var _excluded6 = ["as"];
var _excluded7$2 = ["as", "children", "disabled", "index", "label", "onClick", "onMouseDown", "onMouseEnter", "onMouseLeave", "onMouseMove", "onMouseUp", "onTouchStart", "value"];
var DEBUG = false;
var ListboxDescendantContext = createDescendantContext();
var ListboxContext = createNamedContext("ListboxContext", {});
var ListboxInput = (0, import_react.forwardRef)(__name(function ListboxInput2(_ref2, forwardedRef) {
  ...
  var isControlled = (0, import_react.useRef)(valueProp != null);
  ...
  var hiddenInputRef = (0, import_react.useRef)(null);
  var highlightedOptionRef = (0, import_react.useRef)(null);
  var inputRef = (0, import_react.useRef)(null);
  var listRef = (0, import_react.useRef)(null);
  var popoverRef = (0, import_react.useRef)(null);
  var selectedOptionRef = (0, import_react.useRef)(null);
  ...
  var valueLabel = (0, import_react.useMemo)(function() {
  ...
  return (0, import_react.createElement)(Comp, _extends$4({}, props2, {
    ref,
    "data-reach-listbox-input": "",
    "data-state": isExpanded ? "expanded" : "closed",
    "data-value": state2.context.value,
    id: id2
  }), (0, import_react.createElement)(ListboxContext.Provider, {
    value: context
  }, (0, import_react.createElement)(DescendantProvider, {
    ...
    valueLabel,
    expanded: isExpanded
  }) : children, (form || name2 || required) && (0, import_react.createElement)("input", {
    ref: hiddenInputRef,
...
var Listbox$1 = (0, import_react.forwardRef)(__name(function Listbox(_ref2, forwardedRef) {
  ...
  return (0, import_react.createElement)(ListboxInput, _extends$4({}, props2, {
    __componentName: "Listbox",
    ref: forwardedRef
  }), function(_ref3) {
    var value3 = _ref3.value, valueLabel = _ref3.valueLabel;
    return (0, import_react.createElement)(import_react.Fragment, null, (0, import_react.createElement)(ListboxButton$1, {
      arrow,
      children: button2 ? isFunction$1(button2) ? button2({
        value: value3,
        label: valueLabel
      }) : button2 : void 0
    }), (0, import_react.createElement)(ListboxPopover2, {
      portal
    }, (0, import_react.createElement)(ListboxList, null, children)));
  });
}, "Listbox"));
var ListboxButtonImpl = (0, import_react.forwardRef)(__name(function ListboxButton(_ref4, forwardedRef) {
  ...
  var label = (0, import_react.useMemo)(function() {
    if (!children) {
  ...
  return (0, import_react.createElement)(Comp, _extends$4({
  ...
  }), label, arrow && (0, import_react.createElement)(ListboxArrow2, null, isBoolean(arrow) ? null : arrow));
}, "ListboxButton"));
var ListboxButton$1 = (0, import_react.memo)(ListboxButtonImpl);
var ListboxArrowImpl = (0, import_react.forwardRef)(__name(function ListboxArrow(_ref5, forwardedRef) {
  ...
  var _React$useContext2 = (0, import_react.useContext)(ListboxContext), isExpanded = _React$useContext2.isExpanded;
  return (0, import_react.createElement)(Comp, _extends$4({
    "aria-hidden": true
  }, props2, {
    ref: forwardedRef,
...
var ListboxArrow2 = (0, import_react.memo)(ListboxArrowImpl);
var ListboxPopoverImpl = (0, import_react.forwardRef)(__name(function ListboxPopover(_ref6, forwardedRef) {
  ...
  var _React$useContext3 = (0, import_react.useContext)(ListboxContext), isExpanded = _React$useContext3.isExpanded, buttonRef = _React$useContext3.buttonRef, popoverRef = _React$useContext3.popoverRef, send2 = _React$useContext3.send;
  var ref = useComposedRefs(popoverRef, forwardedRef);
  var handleKeyDown = useKeyDown$1();
...
var ListboxOption = (0, import_react.forwardRef)(__name(function ListboxOption2(_ref8, forwardedRef) {
  ...
  var _React$useContext5 = (0, import_react.useContext)(ListboxContext), highlightedOptionRef = _React$useContext5.highlightedOptionRef, selectedOptionRef = _React$useContext5.selectedOptionRef, send2 = _React$useContext5.send, isExpanded = _React$useContext5.isExpanded, onValueChange = _React$useContext5.onValueChange, state2 = _React$useContext5.state, _React$useContext5$st = _React$useContext5.stateData, listboxValue = _React$useContext5$st.value, navigationValue4 = _React$useContext5$st.navigationValue;
  var _React$useState = (0, import_react.useState)(labelProp), labelState = _React$useState[0], setLabel = _React$useState[1];
  var label = labelProp || labelState || "";
  var ownRef = (0, import_react.useRef)(null);
  ...
  var descendant = (0, import_react.useMemo)(function() {
    return {
      element,
      value: value3,
      label,
  ...
  var getLabelFromDomNode = (0, import_react.useCallback)(function(node) {
    if (!labelProp && node) {
...
function useKeyDown$1() {
  var _React$useContext9 = (0, import_react.useContext)(ListboxContext), send2 = _React$useContext9.send, listboxDisabled = _React$useContext9.disabled, onValueChange = _React$useContext9.onValueChange, _React$useContext9$st = _React$useContext9.stateData, navigationValue4 = _React$useContext9$st.navigationValue, typeaheadQuery2 = _React$useContext9$st.typeaheadQuery;
  ...
  var handleKeyDown = composeEventHandlers(function(event) {
    ...
    key: "index",
    rotate: true,
    filter: __name(function filter(option) {
      return !option.disabled;
    }, "filter"),
    callback: __name(function callback(nextIndex) {
      send2({
...
function useOptionId(value3) {
  var _React$useContext10 = (0, import_react.useContext)(ListboxContext), listboxId = _React$useContext10.listboxId;
...
function useControlledStateSync(controlPropValue, internalValue, send2) {
  var _React$useRef = (0, import_react.useRef)(controlPropValue != null), isControlled = _React$useRef.current;
...
var _excluded3$3 = ["index", "isLink", "onClick", "onDragStart", "onMouseDown", "onMouseEnter", "onMouseLeave", "onMouseMove", "onMouseUp", "onSelect", "disabled", "onFocus", "valueText", "ref"];
var _excluded5$2 = ["id", "onKeyDown", "ref"];
var _excluded7$1 = ["onBlur", "portal", "position", "ref"];
...
var DropdownDescendantContext = createDescendantContext();
var _createContext = createContext("Dropdown");
var DropdownProvider = _createContext[0];
var useDropdownContext = _createContext[1];
var initialState = {
  triggerId: null,
  isExpanded: false,
  typeaheadQuery: "",
...
var DropdownProvider_ = __name(function DropdownProvider_2(_ref2) {
  ...
  var _React$useReducer = (0, import_react.useReducer)(reducer$1, _extends$3({}, initialState, {
    triggerId
  })), state2 = _React$useReducer[0], dispatch = _React$useReducer[1];
  var triggerClickedRef = (0, import_react.useRef)(false);
  var selectCallbacks = (0, import_react.useRef)([]);
  var readyToSelect = (0, import_react.useRef)(false);
  var mouseDownStartPosRef = (0, import_react.useRef)({
    x: 0,
    y: 0
  });
  (0, import_react.useEffect)(function() {
  ...
  return (0, import_react.createElement)(DescendantProvider, {
    context: DropdownDescendantContext,
    items: descendants,
    set: setDescendants
  }, (0, import_react.createElement)(DropdownProvider, {
    dispatch,
    dropdownId,
    dropdownRef,
...
function useDropdownTrigger(_ref2) {
  ...
  var firstNonDisabledIndex = (0, import_react.useMemo)(function() {
...
function useDropdownItem(_ref4) {
  ...
  var ownRef = (0, import_react.useRef)(null);
  var _React$useState = (0, import_react.useState)(valueTextProp || ""), valueText = _React$useState[0], setValueText = _React$useState[1];
  var setValueTextFromDOM = (0, import_react.useCallback)(function(node) {
    if (!valueTextProp && node != null && node.textContent) {
      setValueText(node.textContent);
    }
  }, [valueTextProp]);
  var mouseEventStarted = (0, import_react.useRef)(false);
  var _useStatefulRefValue = useStatefulRefValue(ownRef, null), element = _useStatefulRefValue[0], handleRefSet = _useStatefulRefValue[1];
  var descendant = (0, import_react.useMemo)(function() {
    return {
      element,
...
function useDropdownItems(_ref6) {
  ...
  var handleKeyDown = composeEventHandlers(__name(function handleKeyDown2(event) {
    var key = event.key;
    if (!isExpanded) {
      return;
    }
    ...
    orientation: "vertical",
    rotate: false,
    filter: __name(function filter(item) {
      return !item.disabled;
    }, "filter"),
    callback: __name(function callback(index) {
      dispatch({
        type: SELECT_ITEM_AT_INDEX,
        payload: {
          index,
...
var _excluded4$2 = ["as"];
var _excluded5$1 = ["as"];
var _excluded7 = ["portal"];
var _excluded8 = ["as"];
var Menu$1 = (0, import_react.forwardRef)(function(_ref2, forwardedRef) {
  var _ref$as = _ref2.as, Comp = _ref$as === void 0 ? import_react.Fragment : _ref$as, id2 = _ref2.id, children = _ref2.children, rest = _objectWithoutPropertiesLoose$2(_ref2, _excluded$2);
  var parentIsFragment = (0, import_react.useMemo)(function() {
    try {
      return reactIs.exports.isFragment((0, import_react.createElement)(Comp, null));
    } catch (err) {
      return false;
    }
  }, [Comp]);
  ...
  return (0, import_react.createElement)(Comp, props2, (0, import_react.createElement)(DropdownProvider_, {
    id: id2,
    children
  }));
});
var MenuButton$1 = (0, import_react.forwardRef)(function(_ref2, forwardedRef) {
  ...
  return (0, import_react.createElement)(Comp, _extends$2({
...
var MenuItemImpl = (0, import_react.forwardRef)(function(_ref3, forwardedRef) {
...
var MenuItem = (0, import_react.forwardRef)(function(_ref4, forwardedRef) {
  var _ref4$as = _ref4.as, as = _ref4$as === void 0 ? "div" : _ref4$as, props2 = _objectWithoutPropertiesLoose$2(_ref4, _excluded4$2);
  return (0, import_react.createElement)(MenuItemImpl, _extends$2({}, props2, {
    ref: forwardedRef,
    as
  }));
});
var MenuItems = (0, import_react.forwardRef)(function(_ref5, forwardedRef) {
...
var MenuList = (0, import_react.forwardRef)(function(_ref7, forwardedRef) {
  ...
  return (0, import_react.createElement)(MenuPopover, {
    portal
  }, (0, import_react.createElement)(MenuItems, _extends$2({}, props2, {
    ref: forwardedRef,
    "data-reach-menu-list": ""
  })));
});
var MenuPopover = (0, import_react.forwardRef)(function(_ref8, forwardedRef) {
...
var ListboxButton2 = (0, import_react.forwardRef)((props2, ref) => jsx(ListboxButton$1, __spreadProps(__spreadValues({}, props2), {
  ref,
  className: clsx("graphiql-un-styled", props2.className)
})));
...
var format$1 = __name(function format(url) {
  var result = "";
  result += url.protocol || "";
  result += url.slashes ? "//" : "";
...
var helpers$1 = {};
var parse_link_label = __name(function parseLinkLabel(state2, start, disableNested) {
...
var parse_link_destination = __name(function parseLinkDestination(str, pos, max) {
...
var parse_link_title = __name(function parseLinkTitle(str, pos, max) {
...
Renderer$1.prototype.renderAttrs = __name(function renderAttrs(token2) {
  var i, l2, result;
  if (!token2.attrs) {
    return "";
  }
...
Renderer$1.prototype.renderToken = __name(function renderToken(tokens, idx, options) {
...
var NEWLINES_RE = /\r\n?|\n/g;
var NULL_RE = /\0/g;
var normalize = __name(function normalize2(state2) {
  var str;
  str = state2.src.replace(NEWLINES_RE, "\n");
  str = str.replace(NULL_RE, "�");
  state2.src = str;
}, "normalize");
var block = __name(function block2(state2) {
  var token2;
...
var inline = __name(function inline2(state2) {
...
var linkify = __name(function linkify2(state2) {
...
var replacements = __name(function replace(state2) {
  var blkIdx;
...
var smartquotes = __name(function smartquotes2(state2) {
  var blkIdx;
  if (!state2.md.options.typographer) {
    return;
  }
...
Token$3.prototype.attrIndex = __name(function attrIndex(name2) {
  var attrs, i, len;
  if (!this.attrs) {
    return -1;
  }
...
Token$3.prototype.attrPush = __name(function attrPush(attrData) {
  if (this.attrs) {
...
Token$3.prototype.attrSet = __name(function attrSet(name2, value3) {
...
Token$3.prototype.attrGet = __name(function attrGet(name2) {
...
Token$3.prototype.attrJoin = __name(function attrJoin(name2, value3) {
...
var table = __name(function table2(state2, startLine, endLine, silent) {
...
var code = __name(function code2(state2, startLine, endLine) {
...
var fence = __name(function fence2(state2, startLine, endLine, silent) {
...
var blockquote = __name(function blockquote2(state2, startLine, endLine, silent) {
...
var hr = __name(function hr2(state2, startLine, endLine, silent) {
...
var list = __name(function list2(state2, startLine, endLine, silent) {
...
var reference = __name(function reference2(state2, startLine, _endLine, silent) {
...
var html_block = __name(function html_block2(state2, startLine, endLine, silent) {
...
var heading = __name(function heading2(state2, startLine, endLine, silent) {
...
var lheading = __name(function lheading2(state2, startLine, endLine) {
...
var paragraph = __name(function paragraph2(state2, startLine) {
...
StateBlock.prototype.isEmpty = __name(function isEmpty(line) {
  return this.bMarks[line] + this.tShift[line] >= this.eMarks[line];
}, "isEmpty");
StateBlock.prototype.skipEmptyLines = __name(function skipEmptyLines(from) {
...
StateBlock.prototype.skipSpaces = __name(function skipSpaces(pos) {
  var ch;
...
StateBlock.prototype.skipSpacesBack = __name(function skipSpacesBack(pos, min) {
  if (pos <= min) {
    return pos;
  }
  while (pos > min) {
...
StateBlock.prototype.skipChars = __name(function skipChars(pos, code3) {
  for (var max = this.src.length; pos < max; pos++) {
...
StateBlock.prototype.skipCharsBack = __name(function skipCharsBack(pos, code3, min) {
  if (pos <= min) {
    return pos;
  }
  while (pos > min) {
...
StateBlock.prototype.getLines = __name(function getLines(begin, end, indent2, keepLastLF) {
...
var text = __name(function text2(state2, silent) {
  var pos = state2.pos;
...
var newline = __name(function newline2(state2, silent) {
...
var _escape = __name(function escape(state2, silent) {
...
var backticks = __name(function backtick(state2, silent) {
...
var strikethrough = {};
strikethrough.tokenize = __name(function strikethrough2(state2, silent) {
...
strikethrough.postProcess = __name(function strikethrough3(state2) {
...
var emphasis = {};
emphasis.tokenize = __name(function emphasis2(state2, silent) {
...
emphasis.postProcess = __name(function emphasis3(state2) {
  var curr, tokens_meta = state2.tokens_meta, max = state2.tokens_meta.length;
...
var link = __name(function link2(state2, silent) {
...
var image = __name(function image2(state2, silent) {
...
var autolink = __name(function autolink2(state2, silent) {
...
var html_inline = __name(function html_inline2(state2, silent) {
...
var entity = __name(function entity2(state2, silent) {
...
var balance_pairs = __name(function link_pairs(state2) {
  var curr, tokens_meta = state2.tokens_meta, max = state2.tokens_meta.length;
...
var text_collapse = __name(function text_collapse2(state2) {
...
LinkifyIt$1.prototype.add = __name(function add(schema, definition) {
  this.__schemas__[schema] = definition;
  compile(this);
  return this;
}, "add");
LinkifyIt$1.prototype.set = __name(function set(options) {
  this.__opts__ = assign(this.__opts__, options);
  return this;
}, "set");
LinkifyIt$1.prototype.test = __name(function test(text3) {
...
LinkifyIt$1.prototype.pretest = __name(function pretest(text3) {
  return this.re.pretest.test(text3);
}, "pretest");
LinkifyIt$1.prototype.testSchemaAt = __name(function testSchemaAt(text3, schema, pos) {
  if (!this.__compiled__[schema.toLowerCase()]) {
    return 0;
  }
  return this.__compiled__[schema.toLowerCase()].validate(text3, pos, this);
}, "testSchemaAt");
LinkifyIt$1.prototype.match = __name(function match(text3) {
  var shift = 0, result = [];
...
LinkifyIt$1.prototype.tlds = __name(function tlds(list3, keepOld) {
...
LinkifyIt$1.prototype.normalize = __name(function normalize3(match2) {
  if (!match2.schema) {
...
LinkifyIt$1.prototype.onCompile = __name(function onCompile() {
}, "onCompile");
...
var ucs2encode = __name((array) => String.fromCodePoint(...array), "ucs2encode");
var basicToDigit = __name(function(codePoint) {
  if (codePoint - 48 < 10) {
    return codePoint - 22;
  }
  if (codePoint - 65 < 26) {
...
var digitToBasic = __name(function(digit, flag) {
  return digit + 22 + 75 * (digit < 26) - ((flag != 0) << 5);
}, "digitToBasic");
var adapt = __name(function(delta2, numPoints, firstTime) {
  let k2 = 0;
...
var decode = __name(function(input) {
  const output = [];
...
var encode = __name(function(input) {
  const output = [];
...
var toUnicode = __name(function(input) {
  return mapDomain(input, function(string) {
    return regexPunycode.test(string) ? decode(string.slice(4).toLowerCase()) : string;
  });
}, "toUnicode");
var toASCII = __name(function(input) {
  return mapDomain(input, function(string) {
...
var punycode_es6 = Object.freeze(Object.defineProperty({
  __proto__: null,
  ucs2decode,
  ucs2encode,
  decode,
...
var require$$8 = getAugmentedNamespace(punycode_es6);
var _default = {
  options: {
    html: false,
    xhtmlOut: false,
...
var MarkdownContent = (0, import_react.forwardRef)((_ga, ref) => {
  ...
  return jsx("div", __spreadProps(__spreadValues({}, props2), {
    ref,
...
var _excluded2$1 = ["label", "ariaLabel", "isVisible", "id"];
var _excluded3$1 = ["ariaLabel", "aria-label", "as", "id", "isVisible", "label", "position", "style", "triggerRect"];
var _excluded4$1 = ["type"];
var _on$1;
var _on2$1;
var _on3$1;
var _on4$1;
...
function useTooltip(_temp) {
  ...
  var _React$useState = (0, import_react.useState)(DEBUG_STYLE ? true : isTooltipVisible(id2, true)), isVisible = _React$useState[0], setIsVisible = _React$useState[1];
  var ownRef = (0, import_react.useRef)(null);
  ...
  function wrapPointerEventHandler(handler) {
    return __name(function onPointerEvent(event) {
...
var Tooltip = (0, import_react.forwardRef)(function(_ref2, forwardedRef) {
  ...
  return (0, import_react.createElement)(import_react.Fragment, null, (0, import_react.cloneElement)(child, trigger), (0, import_react.createElement)(TooltipPopup, _extends$1({
    ref: forwardedRef,
    label,
    "aria-label": DEPRECATED_ariaLabel
  }, tooltip2, props2)));
});
var TooltipPopup = (0, import_react.forwardRef)(__name(function TooltipPopup2(_ref3, forwardRef22) {
  ...
  return isVisible ? (0, import_react.createElement)(Portal, null, (0, import_react.createElement)(TooltipContent, _extends$1({
    ref: forwardRef22,
    label,
    "aria-label": DEPRECATED_ariaLabel,
    isVisible
...
var TooltipContent = (0, import_react.forwardRef)(__name(function TooltipContent2(_ref4, forwardedRef) {
  ...
  return (0, import_react.createElement)(import_react.Fragment, null, (0, import_react.createElement)(Comp, _extends$1({
  ...
  }), label), hasAriaLabel && (0, import_react.createElement)(VisuallyHidden, {
    role: "tooltip",
    id: id2
...
var positionTooltip = __name(function positionTooltip2(triggerRect, tooltipRect, offset) {
  if (offset === void 0) {
...
var tabs = (() => ".graphiql-tabs{display:flex;overflow-x:auto;padding:var(--px-12)}.graphiql-tabs>:not(:first-child){margin-left:var(--px-12)}.graphiql-tab{align-items:stretch;border-radius:var(--border-radius-8);color:hsla(var(--color-neutral),var(--alpha-secondary));display:flex}.graphiql-tab>button.graphiql-tab-close{visibility:hidden}.graphiql-tab.graphiql-tab-active>button.graphiql-tab-close,.graphiql-tab:hover>button.graphiql-tab-close,.graphiql-tab:focus-within>button.graphiql-tab-close{visibility:unset}.graphiql-tab.graphiql-tab-active{background-color:hsla(var(--color-neutral),var(--alpha-background-heavy));color:hsla(var(--color-neutral),1)}button.graphiql-tab-button{padding:var(--px-4) 0 var(--px-4) var(--px-8)}button.graphiql-tab-close{align-items:center;display:flex;padding:var(--px-4) var(--px-8)}button.graphiql-tab-close>svg{height:var(--px-8);width:var(--px-8)}\n")();
var TabRoot = (0, import_react.forwardRef)((_ia, ref) => {
  var _ja = _ia, {
    isActive
...
var TabButton = (0, import_react.forwardRef)((props2, ref) => jsx(UnStyledButton, __spreadProps(__spreadValues({}, props2), {
  ref,
  type: "button",
...
var TabClose = (0, import_react.forwardRef)((props2, ref) => jsx(Tooltip, {
  label: "Close Tab",
  children: jsx(UnStyledButton, __spreadProps(__spreadValues({
...
var Tabs = (0, import_react.forwardRef)((props2, ref) => jsx("div", __spreadProps(__spreadValues({}, props2), {
  ref,
  role: "tablist",
...
var __name$C = __name((target2, value3) => __defProp$C(target2, "name", { value: value3, configurable: true }), "__name$C");
var HistoryContext = createNullableContext("HistoryContext");
function HistoryContextProvider(props2) {
  var _a;
  const storage = useStorageContext();
  const historyStore = (0, import_react.useRef)(new HistoryStore(storage || new StorageAPI(null), props2.maxHistoryLength || DEFAULT_HISTORY_LENGTH));
  const [items, setItems] = (0, import_react.useState)(((_a = historyStore.current) == null ? void 0 : _a.queries) || []);
  const addToHistory = (0, import_react.useCallback)(({
    query,
    variables,
    headers,
    operationName
  ...
  const editLabel = (0, import_react.useCallback)(({
    query,
    variables,
    headers,
    operationName,
  ...
  const toggleFavorite = (0, import_react.useCallback)(({
    query,
    variables,
    headers,
    operationName,
  ...
  const value3 = (0, import_react.useMemo)(() => ({
    addToHistory,
    editLabel,
    items,
    toggleFavorite
  }), [addToHistory, editLabel, items, toggleFavorite]);
  return jsx(HistoryContext.Provider, {
    value: value3,
    children: props2.children
  });
}
    ...
    children: [jsx("div", {
      ...
      children: reversedItems.map((item, i) => {
        return jsxs(import_react.Fragment, {
          children: [jsx(HistoryItem, {
            item
          }), item.favorite && reversedItems[i + 1] && !reversedItems[i + 1].favorite ? jsx("div", {
...
function HistoryItem(props2) {
  ...
  const [isEditable, setIsEditable] = (0, import_react.useState)(false);
  (0, import_react.useEffect)(() => {
  ...
  return jsx("li", {
    ...
    children: isEditable ? jsxs(Fragment2, {
      children: [jsx("input", {
        type: "text",
      ...
      children: [jsx(UnStyledButton, {
        ...
        children: jsx(UnStyledButton, {
          ...
          children: props2.item.favorite ? jsx(StarFilledIcon, {
            "aria-hidden": "true"
          }) : jsx(StarIcon, {
            "aria-hidden": "true"
          })
...
var __name$A = __name((target2, value3) => __defProp$A(target2, "name", { value: value3, configurable: true }), "__name$A");
...
function ExecutionContextProvider({
  ...
  const queryIdRef = (0, import_react.useRef)(0);
  const stop = (0, import_react.useCallback)(() => {
    subscription == null ? void 0 : subscription.unsubscribe();
    setIsFetching(false);
    setSubscription(null);
  }, [subscription]);
  const run3 = (0, import_react.useCallback)(async () => {
    var _a, _b;
    ...
    const setResponse = __name$A((value22) => {
    ...
    try {
      ...
      const handleResponse = __name$A((result) => {
  ...
  return jsx(ExecutionContext.Provider, {
    value: value3,
    children
  });
}
...
var __name$z = __name((target2, value3) => __defProp$z(target2, "name", { value: value3, configurable: true }), "__name$z");
...
async function importCodeMirror(addons, options) {
  const CodeMirror = await import("./codemirror.es-VV3FLCEQ.js").then(function(n2) {
    return n2.c;
  }).then((c2) => typeof c2 === "function" ? c2 : c2.default);
  await Promise.all((options == null ? void 0 : options.useCommonAddons) === false ? addons : [
    import("./show-hint.es-PNP4X23S.js").then(function(n2) {
      return n2.s;
    }),
    import("./matchbrackets.es-N5AOULXS.js").then(function(n2) {
      return n2.m;
    }),
    import("./closebrackets.es-XRDLLXUF.js").then(function(n2) {
      return n2.c;
    }),
    import("./brace-fold.es-QNCSE47R.js").then(function(n2) {
      return n2.b;
    }),
    import("./foldgutter.es-3RAOLRKB.js").then(function(n2) {
      return n2.f;
    }),
    import("./lint.es3-LETQIS7M.js").then(function(n2) {
      return n2.l;
    }),
    import("./searchcursor.es-VTX4OM6A.js").then(function(n2) {
      return n2.s;
    }),
    import("./jump-to-line.es-L6BQV6IG.js").then(function(n2) {
      return n2.j;
    }),
    import("./dialog.es-MK7N7TCR.js").then(function(n2) {
      return n2.d;
    }),
    import("./sublime.es-QTFQCZHR.js").then(function(n2) {
      return n2.s;
    }),
    ...addons
  ]);
...
var toggleSelection = __name(function() {
...
var defaultValue = (() => ".graphiql-doc-explorer-default-value{color:hsl(var(--color-success))}\n")();
var __defProp$y = Object.defineProperty;
var __name$y = __name((target2, value3) => __defProp$y(target2, "name", { value: value3, configurable: true }), "__name$y");
var printDefault = __name$y((ast2) => {
  if (!ast2) {
    return "";
  }
  return print(ast2);
...
function DefaultValue({
  ...
  const ast2 = astFromValue(field.defaultValue, field.type);
  if (!ast2) {
    return null;
  }
...
var __name$x = __name((target2, value3) => __defProp$x(target2, "name", { value: value3, configurable: true }), "__name$x");
...
function SchemaContextProvider(props2) {
  ...
  const headersRef = (0, import_react.useRef)(initialHeaders);
  (0, import_react.useEffect)(() => {
    if (headerEditor) {
  ...
  const introspect = (0, import_react.useCallback)(() => {
  ...
  const validationErrors = (0, import_react.useMemo)(() => {
  ...
  return jsx(SchemaContext.Provider, {
    value: value3,
    children
  });
}
...
var __name$w = __name((target2, value3) => __defProp$w(target2, "name", { value: value3, configurable: true }), "__name$w");
...
function ExplorerContextProvider(props2) {
  ...
  const [navStack, setNavStack] = (0, import_react.useState)([initialNavStackItem]);
  ...
  return jsx(ExplorerContext.Provider, {
    value: value3,
    children: props2.children
  });
}
...
var __name$v = __name((target2, value3) => __defProp$v(target2, "name", { value: value3, configurable: true }), "__name$v");
...
var typeLink = (() => "a.graphiql-doc-explorer-type-name{color:hsl(var(--color-warning));text-decoration:none}a.graphiql-doc-explorer-type-name:hover{text-decoration:underline}a.graphiql-doc-explorer-type-name:focus{outline:hsl(var(--color-warning)) auto 1px}\n")();
var __defProp$u = Object.defineProperty;
var __name$u = __name((target2, value3) => __defProp$u(target2, "name", { value: value3, configurable: true }), "__name$u");
function TypeLink(props2) {
  ...
  return renderType(props2.type, (namedType) => jsx("a", {
...
var argument = (() => ".graphiql-doc-explorer-argument>*+*{margin-top:var(--px-12)}.graphiql-doc-explorer-argument-name{color:hsl(var(--color-secondary))}.graphiql-doc-explorer-argument-deprecation{background-color:hsla(var(--color-warning),var(--alpha-background-light));border:1px solid hsl(var(--color-warning));border-radius:var(--border-radius-4);color:hsl(var(--color-warning));padding:var(--px-8)}.graphiql-doc-explorer-argument-deprecation-label{font-size:var(--font-size-hint);font-weight:var(--font-weight-medium)}\n")();
var __defProp$t = Object.defineProperty;
var __name$t = __name((target2, value3) => __defProp$t(target2, "name", { value: value3, configurable: true }), "__name$t");
function Argument({
  arg,
  showDefaultValue,
  inline: inline3
}) {
  const definition = jsxs("span", {
    children: [jsx("span", {
      className: "graphiql-doc-explorer-argument-name",
      children: arg.name
    }), ": ", jsx(TypeLink, {
      type: arg.type
    }), showDefaultValue !== false && jsx(DefaultValue, {
      field: arg
    })]
  });
  if (inline3) {
  ...
  return jsxs("div", {
    ...
    children: [definition, arg.description ? jsx(MarkdownContent, {
      type: "description",
      children: arg.description
    }) : null, arg.deprecationReason ? jsxs("div", {
...
var deprecationReason = (() => ".graphiql-doc-explorer-deprecation{background-color:hsla(var(--color-warning),var(--alpha-background-light));border:1px solid hsl(var(--color-warning));border-radius:var(--px-4);color:hsl(var(--color-warning));padding:var(--px-8)}.graphiql-doc-explorer-deprecation-label{font-size:var(--font-size-hint);font-weight:var(--font-weight-medium)}\n")();
var __defProp$s = Object.defineProperty;
var __name$s = __name((target2, value3) => __defProp$s(target2, "name", { value: value3, configurable: true }), "__name$s");
function DeprecationReason(props2) {
  return props2.children ? jsxs("div", {
...
var directive = (() => ".graphiql-doc-explorer-directive{color:hsl(var(--color-secondary))}\n")();
var __defProp$r = Object.defineProperty;
var __name$r = __name((target2, value3) => __defProp$r(target2, "name", { value: value3, configurable: true }), "__name$r");
function Directive({
...
var __name$p = __name((target2, value3) => __defProp$p(target2, "name", { value: value3, configurable: true }), "__name$p");
function FieldDocumentation(props2) {
  return jsxs(Fragment2, {
    children: [props2.field.description ? jsx(MarkdownContent, {
      type: "description",
      children: props2.field.description
    }) : null, jsx(DeprecationReason, {
      children: props2.field.deprecationReason
    }), jsx(ExplorerSection, {
      title: "Type",
      children: jsx(TypeLink, {
...
function Arguments({
  ...
  const [showDeprecated, setShowDeprecated] = (0, import_react.useState)(false);
  if (!("args" in field)) {
    return null;
  }
  const args = [];
  ...
  return jsxs(Fragment2, {
    children: [args.length > 0 ? jsx(ExplorerSection, {
      title: "Arguments",
      children: args.map((arg) => jsx(Argument, {
        arg
      }, arg.name))
    }) : null, deprecatedArgs.length > 0 ? showDeprecated || args.length === 0 ? jsx(ExplorerSection, {
      title: "Deprecated Arguments",
      children: deprecatedArgs.map((arg) => jsx(Argument, {
        arg
      }, arg.name))
    }) : jsx(Button, {
      type: "button",
...
function Directives({
  ...
  return jsx(ExplorerSection, {
    title: "Directives",
    children: directives.map((directive2) => jsx("div", {
      children: jsx(Directive, {
        directive: directive2
      })
...
var schemaDocumentation = (() => ".graphiql-doc-explorer-root-type{color:hsl(var(--color-info))}\n")();
var __defProp$o = Object.defineProperty;
var __name$o = __name((target2, value3) => __defProp$o(target2, "name", { value: value3, configurable: true }), "__name$o");
...
var _excluded2 = ["as", "selectOnClick", "autocomplete", "onClick", "onChange", "onKeyDown", "onBlur", "onFocus", "value"];
var _excluded3 = ["as", "children", "portal", "onKeyDown", "onBlur", "position"];
var _excluded4 = ["persistSelection", "as"];
var _excluded5 = ["as", "children", "index", "value", "onClick"];
var _on;
var _on2;
var _on3;
var _on4;
...
var reducer = __name(function reducer2(data, event) {
...
var ComboboxDescendantContext = createDescendantContext();
var ComboboxContext = createNamedContext("ComboboxContext", {});
var OptionContext = createNamedContext("OptionContext", {});
var Combobox = (0, import_react.forwardRef)(function(_ref2, forwardedRef) {
  ...
  var _useDescendantsInit = useDescendantsInit(), options = _useDescendantsInit[0], setOptions = _useDescendantsInit[1];
  var inputRef = (0, import_react.useRef)();
  var popoverRef = (0, import_react.useRef)();
  var buttonRef = (0, import_react.useRef)();
  var autocompletePropRef = (0, import_react.useRef)(false);
  var persistSelectionRef = (0, import_react.useRef)(false);
  var defaultData = {
    value: "",
    navigationValue: null
  };
  ...
  var isControlledRef = (0, import_react.useRef)(false);
  ...
  return (0, import_react.createElement)(DescendantProvider, {
    ...
    items: options,
    set: setOptions
  }, (0, import_react.createElement)(ComboboxContext.Provider, {
    value: context
  }, (0, import_react.createElement)(Comp, _extends({}, props2, {
    "data-reach-combobox": "",
...
var ComboboxInput = (0, import_react.forwardRef)(function(_ref2, forwardedRef) {
  ...
  var handleValueChange = (0, import_react.useCallback)(function(value4) {
    if (value4.trim() === "") {
      transition2(CLEAR, {
        isControlled
      });
  ...
  return (0, import_react.createElement)(Comp, _extends({
...
var ComboboxPopover = (0, import_react.forwardRef)(function(_ref3, forwardedRef) {
  ...
  var _React$useContext2 = (0, import_react.useContext)(ComboboxContext), popoverRef = _React$useContext2.popoverRef, inputRef = _React$useContext2.inputRef, isExpanded = _React$useContext2.isExpanded, state2 = _React$useContext2.state;
  var ref = useComposedRefs(popoverRef, forwardedRef);
  var handleKeyDown = useKeyDown();
  var handleBlur = useBlur();
  var sharedProps = {
  ...
  return portal ? (0, import_react.createElement)(Popover, _extends({
    as: Comp
  }, props2, {
    ref,
    "data-expanded": isExpanded || void 0,
    ...
    targetRef: inputRef,
    unstable_skipInitialPortalRender: true
  }, sharedProps)) : (0, import_react.createElement)(Comp, _extends({
    ref
  }, props2, sharedProps));
});
var ComboboxList = (0, import_react.forwardRef)(function(_ref4, forwardedRef) {
  ...
  var _React$useContext3 = (0, import_react.useContext)(ComboboxContext), persistSelectionRef = _React$useContext3.persistSelectionRef, listboxId = _React$useContext3.listboxId;
  if (persistSelection) {
...
var ComboboxOption = (0, import_react.forwardRef)(function(_ref5, forwardedRef) {
  ...
  var _React$useContext4 = (0, import_react.useContext)(ComboboxContext), onSelect = _React$useContext4.onSelect, navigationValue4 = _React$useContext4.data.navigationValue, transition2 = _React$useContext4.transition, isControlledRef = _React$useContext4.isControlledRef;
  var ownRef = (0, import_react.useRef)(null);
  var _useStatefulRefValue = useStatefulRefValue(ownRef, null), element = _useStatefulRefValue[0], handleRefSet = _useStatefulRefValue[1];
  var descendant = (0, import_react.useMemo)(function() {
    return {
  ...
  var handleClick = __name(function handleClick2() {
  ...
  return (0, import_react.createElement)(OptionContext.Provider, {
    value: {
      value: value3,
      index
    }
  }, (0, import_react.createElement)(Comp, _extends({
    "aria-selected": isActive,
    role: "option"
  }, props2, {
    ...
    value: value3,
    index
  }) : children : (0, import_react.createElement)(ComboboxOptionText, null)));
});
function ComboboxOptionText() {
  var _React$useContext5 = (0, import_react.useContext)(OptionContext), value3 = _React$useContext5.value;
  var _React$useContext6 = (0, import_react.useContext)(ComboboxContext), contextValue = _React$useContext6.data.value;
  var results = (0, import_react.useMemo)(function() {
    return HighlightWords.findAll({
      searchWords: escapeRegexp(contextValue || "").split(/\s+/),
      textToHighlight: value3
    });
  }, [contextValue, value3]);
  return (0, import_react.createElement)(import_react.Fragment, null, results.length ? results.map(function(result, index) {
...
function useKeyDown() {
  var _React$useContext8 = (0, import_react.useContext)(ComboboxContext), navigationValue4 = _React$useContext8.data.navigationValue, onSelect = _React$useContext8.onSelect, state2 = _React$useContext8.state, transition2 = _React$useContext8.transition, autocompletePropRef = _React$useContext8.autocompletePropRef, persistSelectionRef = _React$useContext8.persistSelectionRef, isControlledRef = _React$useContext8.isControlledRef;
...
function useBlur() {
  var _React$useContext9 = (0, import_react.useContext)(ComboboxContext), state2 = _React$useContext9.state, transition2 = _React$useContext9.transition, popoverRef = _React$useContext9.popoverRef, inputRef = _React$useContext9.inputRef, buttonRef = _React$useContext9.buttonRef;
  return __name(function handleBlur(event) {
...
function useReducerMachine(chart2, reducer3, initialData) {
  var _React$useState = (0, import_react.useState)(chart2.initial), state2 = _React$useState[0], setState = _React$useState[1];
  var _React$useReducer = (0, import_react.useReducer)(reducer3, initialData), data = _React$useReducer[0], dispatch = _React$useReducer[1];
  var transition2 = __name(function transition3(event, payload) {
    if (payload === void 0) {
      payload = {};
    }
...
var __name$n = __name((target2, value3) => __defProp$n(target2, "name", { value: value3, configurable: true }), "__name$n");
...
function Search() {
  ...
  const [results, setResults] = (0, import_react.useState)(getSearchResults(searchValue));
  const debouncedGetSearchResults = (0, import_react.useMemo)(() => debounce(200, (search2) => {
  ...
  return shouldSearchBoxAppear ? jsxs(Combobox, {
    ...
    children: [jsxs("div", {
      ...
      children: [jsx(MagnifyingGlassIcon, {}), jsx(ComboboxInput, {
        autocomplete: false,
        onChange: (event) => {
      ...
      portal: false,
      ref: popoverRef,
      children: jsxs(ComboboxList, {
        children: [results.within.map((result, i) => jsx(ComboboxOption, {
          index: i,
          value: result,
        ...
        }, `within-${i}`)), results.within.length > 0 && results.types.length + results.fields.length > 0 ? jsx("div", {
          className: "graphiql-doc-explorer-search-divider",
          children: "Other results"
        }) : null, results.types.map((result, i) => jsx(ComboboxOption, {
          index: results.within.length + i,
          value: result,
          children: jsx(Type, {
            type: result.type
          })
        }, `type-${i}`)), results.fields.map((result, i) => jsxs(ComboboxOption, {
        ...
        }, `field-${i}`)), results.within.length + results.types.length + results.fields.length === 0 ? jsx("div", {
...
function useSearchResults(caller) {
  ...
  const navItem = explorerNavStack.at(-1);
  return (0, import_react.useCallback)((searchValue) => {
    const matches2 = {
      within: [],
      types: [],
      fields: []
...
function Field$1(props2) {
  return jsxs(Fragment2, {
    ...
    }), props2.argument ? jsxs(Fragment2, {
      children: ["(", jsx("span", {
        className: "graphiql-doc-explorer-search-argument",
        children: props2.argument.name
      }), ":", " ", renderType(props2.argument.type, (namedType) => jsx(Type, {
        type: namedType
      })), ")"]
    }) : null]
  });
...
var fieldLink = (() => "a.graphiql-doc-explorer-field-name{color:hsl(var(--color-info));text-decoration:none}a.graphiql-doc-explorer-field-name:hover{text-decoration:underline}a.graphiql-doc-explorer-field-name:focus{outline:hsl(var(--color-info)) auto 1px}\n")();
var __defProp$l = Object.defineProperty;
var __name$l = __name((target2, value3) => __defProp$l(target2, "name", { value: value3, configurable: true }), "__name$l");
...
var typeDocumentation = (() => ".graphiql-doc-explorer-item>:not(:first-child){margin-top:var(--px-12)}.graphiql-doc-explorer-argument-multiple{margin-left:var(--px-8)}.graphiql-doc-explorer-enum-value{color:hsl(var(--color-info))}\n")();
var __defProp$k = Object.defineProperty;
var __name$k = __name((target2, value3) => __defProp$k(target2, "name", { value: value3, configurable: true }), "__name$k");
function TypeDocumentation(props2) {
  return isNamedType(props2.type) ? jsxs(Fragment2, {
    children: [props2.type.description ? jsx(MarkdownContent, {
      type: "description",
      children: props2.type.description
    }) : null, jsx(ImplementsInterfaces, {
      type: props2.type
    }), jsx(Fields, {
      type: props2.type
    }), jsx(EnumValues, {
...
function ImplementsInterfaces({
  ...
  return interfaces.length > 0 ? jsx(ExplorerSection, {
    title: "Implements",
    children: type2.getInterfaces().map((implementedInterface) => jsx("div", {
      children: jsx(TypeLink, {
...
function Fields({
  ...
  return jsxs(Fragment2, {
    children: [fields.length > 0 ? jsx(ExplorerSection, {
      title: "Fields",
      children: fields.map((field) => jsx(Field, {
        field
      }, field.name))
    }) : null, deprecatedFields.length > 0 ? showDeprecated || fields.length === 0 ? jsx(ExplorerSection, {
      title: "Deprecated Fields",
      children: deprecatedFields.map((field) => jsx(Field, {
        field
      }, field.name))
    }) : jsx(Button, {
      type: "button",
...
function Field({
  ...
  return jsxs("div", {
    ...
    children: [jsxs("div", {
      children: [jsx(FieldLink, {
        field
      }), args.length > 0 ? jsxs(Fragment2, {
        children: ["(", jsx("span", {
          children: args.map((arg) => args.length === 1 ? jsx(Argument, {
            arg,
            inline: true
          }, arg.name) : jsx("div", {
            className: "graphiql-doc-explorer-argument-multiple",
            children: jsx(Argument, {
              arg,
              inline: true
            })
          }, arg.name))
    ...
    }), field.description ? jsx(MarkdownContent, {
      type: "description",
      onlyShowFirstChild: true,
...
function EnumValues({
  ...
  return jsxs(Fragment2, {
    children: [values.length > 0 ? jsx(ExplorerSection, {
      title: "Enum Values",
      children: values.map((value3) => jsx(EnumValue, {
        value: value3
      }, value3.name))
    }) : null, deprecatedValues.length > 0 ? showDeprecated || values.length === 0 ? jsx(ExplorerSection, {
      title: "Deprecated Enum Values",
      children: deprecatedValues.map((value3) => jsx(EnumValue, {
        value: value3
      }, value3.name))
    }) : jsx(Button, {
      type: "button",
...
function EnumValue({
  ...
  return jsxs("div", {
    ...
    }), value3.description ? jsx(MarkdownContent, {
      type: "description",
      children: value3.description
    }) : null, value3.deprecationReason ? jsx(MarkdownContent, {
      type: "deprecation",
...
function PossibleTypes({
  ...
  return jsx(ExplorerSection, {
    ...
    children: schema.getPossibleTypes(type2).map((possibleType) => jsx("div", {
      children: jsx(TypeLink, {
        type: possibleType
      })
    }, possibleType.name))
...
function DocExplorer() {
  ...
  if (fetchError) {
    ...
    content = jsx(SchemaDocumentation, {
      schema
    });
  } else if (isType(navItem.def)) {
    content = jsx(TypeDocumentation, {
      type: navItem.def
    });
  } else if (navItem.def) {
    content = jsx(FieldDocumentation, {
      field: navItem.def
    });
  }
  let prevName;
    ...
    children: [jsxs("div", {
      ...
      children: [jsxs("div", {
        ...
        children: [prevName && jsxs("a", {
          ...
          children: [jsx(ChevronLeftIcon, {}), prevName]
        }), jsx("div", {
        ...
        children: jsx(Search, {}, navItem.name)
      })]
    }), jsx("div", {
...
var __name$i = __name((target2, value3) => __defProp$i(target2, "name", { value: value3, configurable: true }), "__name$i");
var DOC_EXPLORER_PLUGIN = {
  title: "Documentation Explorer",
  icon: __name$i(__name(function Icon() {
    const pluginContext = usePluginContext();
    return (pluginContext == null ? void 0 : pluginContext.visiblePlugin) === DOC_EXPLORER_PLUGIN ? jsx(DocsFilledIcon, {}) : jsx(DocsIcon, {});
  }, "Icon"), "Icon"),
  content: DocExplorer
};
var HISTORY_PLUGIN = {
...
function PluginContextProvider(props2) {
  ...
  const [visiblePlugin, internalSetVisiblePlugin] = (0, import_react.useState)(() => {
  ...
  const setVisiblePlugin = (0, import_react.useCallback)((plugin) => {
  ...
  return jsx(PluginContext.Provider, {
    value: value3,
    children
  });
}
...
var __name$h = __name((target2, value3) => __defProp$h(target2, "name", { value: value3, configurable: true }), "__name$h");
  ...
  importCodeMirror([], { useCommonAddons: false }).then((CodeMirror) => {
    ...
    CodeMirror.on(data, "select", (ctx, el2) => {
      if (!information) {
        ...
        let onRemoveFn;
        hintsUl.addEventListener("DOMNodeRemoved", onRemoveFn = __name$h((event) => {
      ...
      if (typeNamePill && typeNamePrefix && typeName && typeNameSuffix) {
        if (ctx.type) {
          ...
          const renderType2 = __name$h((type2) => {
            if (isNonNullType(type2)) {
...
function useChangeHandler(editor2, callback, storageKey, tabProperty, caller) {
  ...
  (0, import_react.useEffect)(() => {
    ...
    const handleChange = __name$g((editorInstance, changeObj) => {
      if (!changeObj) {
        return;
      }
...
function useCompletion(editor2, callback, caller) {
  ...
  (0, import_react.useEffect)(() => {
    ...
    const handleCompletion = __name$g((instance, changeObj) => {
...
function useHeaderEditor({
  ...
  (0, import_react.useEffect)(() => {
    let isActive = true;
    importCodeMirror([
      import("./javascript.es-5MMIIZ2I.js").then(function(n2) {
        return n2.j;
      })
    ]).then((CodeMirror) => {
      if (!isActive) {
...
var __defProp$e = Object.defineProperty;
var __name$e = __name((target2, value3) => __defProp$e(target2, "name", { value: value3, configurable: true }), "__name$e");
var invalidCharacters = Array.from({ length: 11 }, (_, i) => {
...
function useQueryEditor({
  ...
  const ref = (0, import_react.useRef)(null);
  const codeMirrorRef = (0, import_react.useRef)();
  const onClickReferenceRef = (0, import_react.useRef)(() => {
  });
  (0, import_react.useEffect)(() => {
  ...
  (0, import_react.useEffect)(() => {
    let isActive = true;
    importCodeMirror([
      import("./comment.es-KX3VDSMR.js").then(function(n2) {
        return n2.c;
      }),
      import("./search.es-5AO36PJV.js").then(function(n2) {
        return n2.s;
      }),
      import("./hint.es-7THWYAO3.js"),
      import("./lint.es-F7CZTJXQ.js"),
      import("./info.es-YPGBQLVZ.js"),
      import("./jump.es-VNAEHNA7.js"),
      import("./mode.es-CGH66ZC3.js")
    ]).then((CodeMirror) => {
      if (!isActive) {
        return;
      }
  ...
  const runAtCursor = (0, import_react.useCallback)(() => {
    var _a;
...
function useSynchronizeExternalFragments(editor2, externalFragments, codeMirrorRef) {
  const externalFragmentList = (0, import_react.useMemo)(() => [...externalFragments.values()], [externalFragments]);
  (0, import_react.useEffect)(() => {
    if (!editor2) {
      return;
    }
...
function useSynchronizeActiveTabValues({
  ...
  return (0, import_react.useCallback)((state2) => {
    var _a, _b, _c, _d, _e;
...
function useStoreTabs({
  ...
  const store = (0, import_react.useMemo)(() => debounce(500, (value3) => {
    storage == null ? void 0 : storage.set(STORAGE_KEY$2, value3);
  }), [storage]);
  return (0, import_react.useCallback)((currentState) => {
...
function useVariableEditor({
  ...
  (0, import_react.useEffect)(() => {
    let isActive = true;
    importCodeMirror([
      import("./hint.es2-7ZMVSEES.js"),
      import("./lint.es2-C5JVUEE4.js"),
      import("./mode.es3-73XTMRPK.js")
    ]).then((CodeMirror) => {
      if (!isActive) {
        return;
      }
...
function EditorContextProvider(props2) {
  const storage = useStorageContext();
  const [headerEditor, setHeaderEditor] = (0, import_react.useState)(null);
  const [queryEditor, setQueryEditor] = (0, import_react.useState)(null);
  const [responseEditor, setResponseEditor] = (0, import_react.useState)(null);
  const [variableEditor, setVariableEditor] = (0, import_react.useState)(null);
  const [shouldPersistHeaders, setShouldPersistHeadersInternal] = (0, import_react.useState)(() => {
  ...
  const [initialState2] = (0, import_react.useState)(() => {
  ...
  const [tabState, setTabState] = (0, import_react.useState)(initialState2.tabState);
  const setShouldPersistHeaders = (0, import_react.useCallback)((persist) => {
    var _a;
    if (persist) {
  ...
  const lastShouldPersistHeadersProp = (0, import_react.useRef)(void 0);
  (0, import_react.useEffect)(() => {
  ...
  const addTab = (0, import_react.useCallback)(() => {
    setTabState((current) => {
  ...
  const changeTab = (0, import_react.useCallback)((index) => {
    setTabState((current) => {
  ...
  const closeTab = (0, import_react.useCallback)((index) => {
    setTabState((current) => {
      const updated = {
  ...
  const updateActiveTabValues = (0, import_react.useCallback)((partialTab) => {
    setTabState((current) => {
  ...
  const setOperationName = (0, import_react.useCallback)((operationName) => {
    if (!queryEditor) {
      return;
    }
  ...
  const externalFragments = (0, import_react.useMemo)(() => {
    ...
    if (Array.isArray(props2.externalFragments)) {
      ...
      visit(parse(props2.externalFragments, {}), {
  ...
  const validationRules = (0, import_react.useMemo)(() => props2.validationRules || [], [props2.validationRules]);
  const value3 = (0, import_react.useMemo)(() => __spreadProps(__spreadValues({}, tabState), {
    addTab,
    changeTab,
    closeTab,
    updateActiveTabValues,
  ...
  return jsx(EditorContext.Provider, {
    value: value3,
    children
  });
}
...
var __name$8 = __name((target2, value3) => __defProp$8(target2, "name", { value: value3, configurable: true }), "__name$8");
function ImagePreview(props2) {
  ...
  const [mime, setMime] = (0, import_react.useState)(null);
  const ref = (0, import_react.useRef)(null);
  ...
  const dims = dimensions.width !== null && dimensions.height !== null ? jsxs("div", {
...
ImagePreview.shouldRender = __name$8(__name(function shouldRender(token2) {
...
var __name$6 = __name((target2, value3) => __defProp$6(target2, "name", { value: value3, configurable: true }), "__name$6");
function useResponseEditor({
  ...
  const ref = (0, import_react.useRef)(null);
  const responseTooltipRef = (0, import_react.useRef)(responseTooltip);
  (0, import_react.useEffect)(() => {
  ...
  (0, import_react.useEffect)(() => {
    ...
    importCodeMirror([
      ...
      import("./mode.es2-L3NN5MIA.js"),
      import("./info-addon.es-UIX3ONYS.js")
    ], {
      ...
      CodeMirror.registerHelper("info", "graphql-results", (token2, _options, _cm, pos) => {
        ...
        if (ResponseTooltipComponent) {
          infoElements.push(jsx(ResponseTooltipComponent, {
            pos,
            token: token2
          }));
        }
        if (ImagePreview.shouldRender(token2)) {
          infoElements.push(jsx(ImagePreview, {
            token: token2
          }, "image-preview"));
        }
        if (!infoElements.length) {
          import_react_dom.default.unmountComponentAtNode(tooltipDiv);
          return null;
        }
        import_react_dom.default.render(infoElements, tooltipDiv);
        return tooltipDiv;
      });
      const container = ref.current;
      if (!container) {
...
var __name$5 = __name((target2, value3) => __defProp$5(target2, "name", { value: value3, configurable: true }), "__name$5");
...
var __name$4 = __name((target2, value3) => __defProp$4(target2, "name", { value: value3, configurable: true }), "__name$4");
...
var __name$3 = __name((target2, value3) => __defProp$3(target2, "name", { value: value3, configurable: true }), "__name$3");
function GraphiQLProvider({
  ...
  return jsx(StorageContextProvider, {
    storage,
    children: jsx(HistoryContextProvider, {
      maxHistoryLength,
      children: jsx(EditorContextProvider, {
        defaultQuery,
        defaultHeaders,
        defaultTabs,
        externalFragments,
        ...
        validationRules,
        variables,
        children: jsx(SchemaContextProvider, {
          dangerouslyAssumeSchemaIsValid,
          fetcher,
          inputValueDeprecation,
          introspectionQueryName,
          ...
          schema,
          schemaDescription,
          children: jsx(ExecutionContextProvider, {
            getDefaultFieldNames,
            fetcher,
            operationName,
            children: jsx(ExplorerContextProvider, {
              children: jsx(PluginContextProvider, {
                onTogglePluginVisibility,
                plugins,
                visiblePlugin,
                children
...
var __name$2 = __name((target2, value3) => __defProp$2(target2, "name", { value: value3, configurable: true }), "__name$2");
function useTheme() {
  const storageContext = useStorageContext();
  const [theme, setThemeInternal] = (0, import_react.useState)(() => {
    if (!storageContext) {
      return null;
    }
  ...
  return (0, import_react.useMemo)(() => ({ theme, setTheme }), [theme, setTheme]);
}
__name(useTheme, "useTheme");
__name$2(useTheme, "useTheme");
var STORAGE_KEY = "theme";
var __defProp$1 = Object.defineProperty;
var __name$1 = __name((target2, value3) => __defProp$1(target2, "name", { value: value3, configurable: true }), "__name$1");
function useDragResize({
  ...
  const [hiddenElement, setHiddenElement] = (0, import_react.useState)(() => {
  ...
  const setHiddenElementWithCallback = (0, import_react.useCallback)((element) => {
  ...
  const dragBarRef = (0, import_react.useRef)(null);
  const secondRef = (0, import_react.useRef)(null);
  const defaultFlexRef = (0, import_react.useRef)(`${defaultSizeRelation}`);
  (0, import_react.useLayoutEffect)(() => {
  ...
  const hide = (0, import_react.useCallback)((resizableElement) => {
  ...
  const show = (0, import_react.useCallback)((resizableElement) => {
    const element = resizableElement === "first" ? firstRef.current : secondRef.current;
    if (!element) {
      return;
    }
...
var button = (() => "button.graphiql-toolbar-button{display:flex;align-items:center;justify-content:center;height:var(--toolbar-width);width:var(--toolbar-width)}button.graphiql-toolbar-button.error{background:hsla(var(--color-error),var(--alpha-background-heavy))}\n")();
var ToolbarButton = (0, import_react.forwardRef)((_oa, ref) => {
  var _pa = _oa, {
    label
  ...
  return jsx(Tooltip, {
    label,
    children: jsx(UnStyledButton, __spreadProps(__spreadValues({}, props2), {
      ref,
      type: "button",
...
function ExecuteButton() {
  ...
  const buttonProps = {
    ...
    children: isRunning ? jsx(StopIcon, {}) : jsx(PlayIcon, {}),
    "aria-label": label
  };
  return hasOptions && !isRunning ? jsxs(Menu, {
    children: [jsx(Tooltip, {
      label,
      children: jsx(Menu.Button, __spreadValues({}, buttonProps))
    }), jsx(Menu.List, {
    ...
    label,
    children: jsx("button", __spreadProps(__spreadValues({}, buttonProps), {
      onClick: () => {
        if (isRunning) {
          stop();
        } else {
...
var listbox = (() => ".graphiql-toolbar-listbox{display:block;height:var(--toolbar-width);width:var(--toolbar-width)}\n")();
var ToolbarListboxRoot = (0, import_react.forwardRef)((_qa, ref) => {
  var _ra = _qa, {
    button: button2,
    children,
    label
  ...
  return jsxs(Listbox2.Input, __spreadProps(__spreadValues({}, props2), {
    ref,
    className: clsx("graphiql-toolbar-listbox", props2.className),
    "aria-label": labelWithValue,
    children: [jsx(Tooltip, {
      label: labelWithValue,
      children: jsx(Listbox2.Button, {
        children: button2
      })
    }), jsx(Listbox2.Popover, {
      children
    })]
  }));
});
...
var menu = (() => "button.graphiql-toolbar-menu{display:block;height:var(--toolbar-width);width:var(--toolbar-width)}\n")();
var ToolbarMenuRoot = (0, import_react.forwardRef)((_sa, ref) => {
  var _ta = _sa, {
    button: button2,
    children,
    label
  ...
  return jsxs(Menu, __spreadProps(__spreadValues({}, props2), {
    ref,
    children: [jsx(Tooltip, {
      label,
...
export {
  commonjsGlobal,
  useStorageContext,
  SchemaMetaFieldDef2 as SchemaMetaFieldDef,
  TypeMetaFieldDef2 as TypeMetaFieldDef,
  TypeNameMetaFieldDef2 as TypeNameMetaFieldDef,
  CharacterStream,
  opt,
  list$1,
  t$2,
...
@graphiql/react/dist/index.es.js:
  (*
  object-assign
  (c) Sindre Sorhus
  @license MIT
  ...
  ***************************************************************************** *)
   ...
   *)
*/
//# sourceMappingURL=chunk-CV6SMSK3.js.map
